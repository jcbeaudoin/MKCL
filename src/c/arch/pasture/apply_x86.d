...
mkcl_object
mkcl_APPLY(mkcl_narg n, mkcl_objectfn fn, mkcl_object *x)
{
	mkcl_object output;
	asm volatile (
...
mkcl_object
mkcl_APPLY_fixed(mkcl_narg n, mkcl_object (*fn)(), mkcl_object *x)
{
	mkcl_object output;
	asm volatile (
	"movl	4(%%ebp),%%edx\n\t"	/* Create a fake frame for debugger */
...
mkcl_object
mkcl_APPLY_closure(mkcl_narg n, mkcl_objectfn fn, mkcl_object cl, mkcl_object *x)
{
	mkcl_object output;
	asm volatile (
	"movl	4(%%ebp),%%edx\n\t"	/* Create a fake frame for debugger */
