...
struct mkcl_cfun mk_cl_numerator_cfunobj = MKCL_CFUN1(mk_cl_numerator, MK_CL_numerator);
...
struct mkcl_cfun mk_cl_realpart_cfunobj = MKCL_CFUN1(mk_cl_realpart, MK_CL_realpart);
