...
#define mkcl_alloc_atomic_align(e,s,d) mkcl_alloc_atomic(e,s)
  ...
  extern struct mkcl_cfun mk_si_gc_dump_cfunobj;
  extern struct mkcl_cfun mk_si_mem_stats_cfunobj;
  extern struct mkcl_cfun mk_si_gc_off_cfunobj;
  extern struct mkcl_cfun mk_si_gc_on_cfunobj;
  extern struct mkcl_cfun mk_si_scrub_values_cfunobj;
  extern struct mkcl_cfun mk_si_gc_stats_cfunobj;
  extern struct mkcl_cfun mk_si_gc_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_sample_allocation_statistics_cfunobj;
  extern struct mkcl_cfun mk_si_reset_allocation_statistics_cfunobj;
  extern struct mkcl_cfun mk_si_room_report_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_mangle_string_cfunobj;
  extern struct mkcl_cfun mk_si_mangle_symbol_cfunobj;
  extern struct mkcl_cfun mk_si_mangle_name_cfunobj;
  extern struct mkcl_cfun mk_si_mangle_function_name_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_array_dimension_cfunobj;
  extern struct mkcl_cfun mk_si_svset_cfunobj;
  extern struct mkcl_cfun mk_si_fill_array_with_elt_cfunobj;
  extern struct mkcl_cfun mk_si_row_major_aset_cfunobj;
  extern struct mkcl_cfun mk_cl_row_major_aref_cfunobj;
  extern struct mkcl_cfun mk_si_make_vector_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_fill_pointer_cfunobj;
  extern struct mkcl_cfun mk_cl_aref_cfunobj;
  extern struct mkcl_cfun mk_cl_array_row_major_index_cfunobj;
  extern struct mkcl_cfun mk_si_aset_cfunobj;
  extern struct mkcl_cfun mk_si_make_pure_array_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_put_sysprop_cfunobj;
  extern struct mkcl_cfun mk_cl_set_cfunobj;
  extern struct mkcl_cfun mk_si_get_sysprop_cfunobj;
  extern struct mkcl_cfun mk_si_rem_sysprop_cfunobj;
  extern struct mkcl_cfun mk_cl_fmakunbound_cfunobj;
  extern struct mkcl_cfun mk_cl_makunbound_cfunobj;
  extern struct mkcl_cfun mk_si_fset_cfunobj;

  extern MKCL_API void mkcl_clear_compiler_properties(MKCL, mkcl_object sym);

  extern struct mkcl_cfun mk_si_clear_compiler_properties_cfunobj;

  extern struct mkcl_cfun mk_si_system_properties_cfunobj;
...
#define _mkcl_big_register2()	env->big_register[2]
  ...
  extern struct mkcl_cfun mk_si_compiled_function_name_cfunobj;
  extern struct mkcl_cfun mk_si_set_compiled_function_name_cfunobj;
  extern struct mkcl_cfun mk_si_set_compiled_function_owner_cfunobj;
  extern struct mkcl_cfun mk_cl_function_lambda_expression_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_clone_closure_cfunobj;
  extern struct mkcl_cfun mk_si_closure_level_cfunobj;
  extern struct mkcl_cfun mk_si_closure_level_var_cfunobj;
  extern struct mkcl_cfun mk_si_closure_level_set_var_cfunobj;
  extern struct mkcl_cfun mk_si_closure_depth_cfunobj;
  extern struct mkcl_cfun mk_si_closure_level_size_cfunobj;
  extern struct mkcl_cfun mk_si_closure_level_outer_level_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_closure_env_cfunobj;
  extern struct mkcl_cfun mk_si_closurep_cfunobj;
  extern struct mkcl_cfun mk_si_closure_producer_cfunobj;
  extern struct mkcl_cfun mk_si_compiled_function_owner_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_get_fun_ref_sym_cfunobj;
  extern struct mkcl_cfun mk_si_update_function_references_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_digit_char_p_cfunobj;
  extern struct mkcl_cfun mk_cl_charE_cfunobj;
  extern struct mkcl_cfun mk_cl_charNE_cfunobj;
  extern struct mkcl_cfun mk_cl_charG_cfunobj;
  extern struct mkcl_cfun mk_cl_charGE_cfunobj;
  extern struct mkcl_cfun mk_cl_charL_cfunobj;
  extern struct mkcl_cfun mk_cl_charLE_cfunobj;
  extern struct mkcl_cfun mk_cl_char_equal_cfunobj;
  extern struct mkcl_cfun mk_cl_char_not_equal_cfunobj;
  extern struct mkcl_cfun mk_cl_char_lessp_cfunobj;
  extern struct mkcl_cfun mk_cl_char_not_lessp_cfunobj;
  extern struct mkcl_cfun mk_cl_char_greaterp_cfunobj;
  extern struct mkcl_cfun mk_cl_char_not_greaterp_cfunobj;
  extern struct mkcl_cfun mk_cl_digit_char_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_graphic_char_p_cfunobj;
  extern struct mkcl_cfun mk_cl_lower_case_p_cfunobj;
  extern struct mkcl_cfun mk_cl_name_char_cfunobj;
  extern struct mkcl_cfun mk_cl_standard_char_p_cfunobj;
  extern struct mkcl_cfun mk_cl_upper_case_p_cfunobj;
...
#include <mkcl/mkcl-unicode.h>
  ...
  extern struct mkcl_cfun mk_cl_find_class_cfunobj;
  extern struct mkcl_cfun mk_cl_class_of_cfunobj;

  /* cmpaux.c */

  extern MKCL_API mkcl_object mk_si_specialp(MKCL, mkcl_object sym);

  extern struct mkcl_cfun mk_si_specialp_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_convert_cmp_lexical_info_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_make_lambda_cfunobj;
  extern struct mkcl_cfun mk_si_process_lambda_list_cfunobj;
  extern struct mkcl_cfun mk_si_function_block_name_cfunobj;
  extern struct mkcl_cfun mk_si_valid_function_name_p_cfunobj;
  extern struct mkcl_cfun mk_si_process_declarations_cfunobj;

  extern MKCL_API mkcl_object mk_si_eval_in_env(MKCL, mkcl_narg narg, mkcl_object form, ...);

  extern struct mkcl_cfun mk_si_eval_in_env_cfunobj;
...
#define mk_si_apply_from_temp_stack_frame mkcl_apply_from_temp_stack_frame
  ...
  extern struct mkcl_cfun mk_si_apply_from_temp_stack_frame_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_bc_disassemble_cfunobj;
  extern struct mkcl_cfun mk_si_bc_split_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_error_cfunobj;
  extern struct mkcl_cfun mk_cl_cerror_cfunobj;
...
#define mkcl_lose(e, m) mkcl_internal_error(e, m, __FILE__, __LINE__)
  ...
  extern struct mkcl_cfun mk_si_errno_string_cfunobj;
  extern struct mkcl_cfun mk_si_libc_error_string_cfunobj;
...
#define mkcl_FEparse_error mkcl_FEreader_error
  ...
  extern struct mkcl_cfun mk_cl_funcall_cfunobj;
  extern struct mkcl_cfun mk_cl_apply_cfunobj;
  extern struct mkcl_cfun mk_si_top_apply_cfunobj;
  extern struct mkcl_cfun mk_cl_eval_cfunobj;
  extern struct mkcl_cfun mk_cl_constantp_cfunobj;
  extern struct mkcl_cfun mk_si_safe_eval_cfunobj;
...
#define mkcl_funcall4(e, fun, a0, a1, a2, a3) (mkcl_validate_function(e, fun)->cfun.f._[4](e, a0, a1, a2, a3))
  ...
  extern struct mkcl_cfun mk_si_foreignp_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_recast_cfunobj;
  extern struct mkcl_cfun mk_si_make_foreign_null_pointer_cfunobj;
  extern struct mkcl_cfun mk_si_trim_ffi_arguments_staging_area_cfunobj;
  extern struct mkcl_cfun mk_si_release_ffi_area_cfunobj;
  extern struct mkcl_cfun mk_si_find_foreign_symbol_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_indexed_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_ref_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_ref_elt_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_set_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_set_elt_cfunobj;
  extern struct mkcl_cfun mk_si_allocate_foreign_data_cfunobj;
  extern struct mkcl_cfun mk_si_pointer_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_address_cfunobj;
  extern struct mkcl_cfun mk_si_foreign_tag_cfunobj;
  extern struct mkcl_cfun mk_si_free_foreign_data_cfunobj;
  extern struct mkcl_cfun mk_si_make_foreign_data_from_array_cfunobj;
  extern struct mkcl_cfun mk_si_load_foreign_module_cfunobj;
  extern struct mkcl_cfun mk_si_unload_foreign_module_cfunobj;
  extern struct mkcl_cfun mk_si_null_pointer_p_cfunobj;
  extern struct mkcl_cfun mk_si_size_of_foreign_elt_type_cfunobj;
  extern struct mkcl_cfun mk_si_call_cfun_cfunobj;
  extern struct mkcl_cfun mk_si_make_dynamic_callback_cfunobj;
...
#define MKCL_LISTEN_ERROR       -3
  ...
  extern struct mkcl_cfun mk_si_copy_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_file_string_length_cfunobj;
  extern struct mkcl_cfun mk_si_stream_external_format_set_cfunobj;
  extern struct mkcl_cfun mk_si_do_read_sequence_cfunobj;
  extern struct mkcl_cfun mk_si_do_write_sequence_cfunobj;
  extern struct mkcl_cfun mk_cl_make_echo_stream_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_echo_stream_input_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_echo_stream_output_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_file_length_cfunobj;
  extern struct mkcl_cfun mk_cl_get_output_stream_string_cfunobj;
  extern struct mkcl_cfun mk_cl_input_stream_p_cfunobj;
  extern struct mkcl_cfun mk_cl_interactive_stream_p_cfunobj;
  extern struct mkcl_cfun mk_cl_make_synonym_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_open_stream_p_cfunobj;
  extern struct mkcl_cfun mk_cl_output_stream_p_cfunobj;
  extern struct mkcl_cfun mk_cl_stream_element_type_cfunobj;
  extern struct mkcl_cfun mk_cl_stream_external_format_cfunobj;
  extern struct mkcl_cfun mk_cl_streamp_cfunobj;
  extern struct mkcl_cfun mk_cl_synonym_stream_symbol_cfunobj;
  extern struct mkcl_cfun mk_cl_two_way_stream_input_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_two_way_stream_output_stream_cfunobj;
  extern struct mkcl_cfun mk_si_file_column_cfunobj;
  extern struct mkcl_cfun mk_si_get_buffering_mode_cfunobj;
  extern struct mkcl_cfun mk_cl_close_cfunobj;
  extern struct mkcl_cfun mk_cl_file_position_cfunobj;
  extern struct mkcl_cfun mk_cl_make_broadcast_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_make_concatenated_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_make_dispatch_macro_character_cfunobj;
  extern struct mkcl_cfun mk_cl_make_string_input_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_make_string_output_stream_cfunobj;
  extern struct mkcl_cfun mk_cl_open_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_ansi_close_cfunobj;
  extern struct mkcl_cfun mk_si_ansi_input_stream_p_cfunobj;
  extern struct mkcl_cfun mk_si_ansi_output_stream_p_cfunobj;
  extern struct mkcl_cfun mk_si_ansi_open_stream_p_cfunobj;
  extern struct mkcl_cfun mk_si_ansi_stream_element_type_cfunobj;
  extern struct mkcl_cfun mk_si_ansi_streamp_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_get_finalizer_cfunobj;
  extern struct mkcl_cfun mk_si_set_finalizer_cfunobj;
  extern struct mkcl_cfun mk_si_get_heap_size_limit_cfunobj;
  extern struct mkcl_cfun mk_si_set_heap_size_limit_cfunobj;

  /* format.c */

  extern MKCL_API mkcl_object mk_cl_format(MKCL, mkcl_narg narg, mkcl_object stream, mkcl_object string, ...);

  extern struct mkcl_cfun mk_cl_format_cfunobj;
...
#define MK_GC_enabled() (!MK_GC_dont_gc)
  ...
  extern struct mkcl_cfun mk_si_generic_function_p_cfunobj;
  extern struct mkcl_cfun mk_si_clear_gfun_cache_cfunobj;

  extern struct mkcl_cfun mk_clos_funcallable_standard_instance_access_cfunobj;
  extern struct mkcl_cfun mk_clos_set_funcallable_instance_function_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_hash_table_count_cfunobj;
  extern struct mkcl_cfun mk_cl_hash_table_p_cfunobj;
  extern struct mkcl_cfun mk_cl_hash_table_rehash_size_cfunobj;
  extern struct mkcl_cfun mk_cl_hash_table_rehash_threshold_cfunobj;
  extern struct mkcl_cfun mk_cl_hash_table_size_cfunobj;
  extern struct mkcl_cfun mk_cl_hash_table_test_cfunobj;
  extern struct mkcl_cfun mk_cl_sxhash_cfunobj;
  extern struct mkcl_cfun mk_cl_gethash_cfunobj;
  extern struct mkcl_cfun mk_si_hash_table_iterator_cfunobj;
  extern struct mkcl_cfun mk_cl_make_hash_table_cfunobj;
  extern struct mkcl_cfun mk_si_hash_eql_cfunobj;
  extern struct mkcl_cfun mk_si_hash_equal_cfunobj;
  extern struct mkcl_cfun mk_si_hash_equalp_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_hash_tables_statistics_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_instance_class_cfunobj;
  extern struct mkcl_cfun mk_si_instance_class_set_cfunobj;
  extern struct mkcl_cfun mk_si_instance_length_cfunobj;
  extern struct mkcl_cfun mk_si_instance_ref_cfunobj;
  extern struct mkcl_cfun mk_si_instance_ref_safe_cfunobj;
  extern struct mkcl_cfun mk_si_instance_set_cfunobj;
  extern struct mkcl_cfun mk_si_instancep_cfunobj;
  extern struct mkcl_cfun mk_si_sl_boundp_cfunobj;
  extern struct mkcl_cfun mk_si_sl_makunbound_cfunobj;
  extern struct mkcl_cfun mk_si_instance_ref_cfunobj;
  extern struct mkcl_cfun mk_si_instance_sig_cfunobj;
  extern struct mkcl_cfun mk_si_instance_sig_set_cfunobj;
  extern struct mkcl_cfun mk_si_instance_sig_set2_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_copy_instance_cfunobj;

  extern MKCL_API mkcl_object mk_si_set_class_proper_name(MKCL, mkcl_object sym, mkcl_object class);

  extern struct mkcl_cfun mk_si_set_class_proper_name_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_unbound_cfunobj;
  extern struct mkcl_cfun mk_si_allocate_raw_instance_cfunobj;
...
#define mk_cl_fourth mk_cl_cadddr
  ...
  extern struct mkcl_cfun mk_cl_rest_cfunobj;
  extern struct mkcl_cfun mk_cl_first_cfunobj;
  extern struct mkcl_cfun mk_cl_second_cfunobj;
  extern struct mkcl_cfun mk_cl_third_cfunobj;
  extern struct mkcl_cfun mk_cl_fourth_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_cons_cfunobj;
  extern struct mkcl_cfun mk_cl_list_cfunobj;
  extern struct mkcl_cfun mk_cl_listX_cfunobj;
  extern struct mkcl_cfun mk_cl_acons_cfunobj;
  extern struct mkcl_cfun mk_cl_ldiff_cfunobj;
  extern struct mkcl_cfun mk_cl_nreconc_cfunobj;
  extern struct mkcl_cfun mk_cl_nth_cfunobj;
  extern struct mkcl_cfun mk_cl_nthcdr_cfunobj;
  extern struct mkcl_cfun mk_cl_revappend_cfunobj;
  extern struct mkcl_cfun mk_cl_rplaca_cfunobj;
  extern struct mkcl_cfun mk_cl_rplacd_cfunobj;
  extern struct mkcl_cfun mk_cl_tailp_cfunobj;
  extern struct mkcl_cfun mk_si_memq_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_alist_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_list_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_tree_cfunobj;
  extern struct mkcl_cfun mk_cl_fifth_cfunobj;
  extern struct mkcl_cfun mk_cl_sixth_cfunobj;
  extern struct mkcl_cfun mk_cl_seventh_cfunobj;
  extern struct mkcl_cfun mk_cl_eighth_cfunobj;
  extern struct mkcl_cfun mk_cl_ninth_cfunobj;
  extern struct mkcl_cfun mk_cl_tenth_cfunobj;
  extern struct mkcl_cfun mk_cl_endp_cfunobj;
  extern struct mkcl_cfun mk_cl_list_length_cfunobj;
  extern struct mkcl_cfun mk_cl_adjoin_cfunobj;
  extern struct mkcl_cfun mk_cl_append_cfunobj;
  extern struct mkcl_cfun mk_cl_assoc_cfunobj;
  extern struct mkcl_cfun mk_cl_butlast_cfunobj;
  extern struct mkcl_cfun mk_cl_last_cfunobj;
  extern struct mkcl_cfun mk_cl_make_list_cfunobj;
  extern struct mkcl_cfun mk_cl_member_cfunobj;
  extern struct mkcl_cfun mk_cl_nbutlast_cfunobj;
  extern struct mkcl_cfun mk_cl_nconc_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubst_cfunobj;
  extern struct mkcl_cfun mk_cl_nsublis_cfunobj;
  extern struct mkcl_cfun mk_cl_pairlis_cfunobj;
  extern struct mkcl_cfun mk_cl_rassoc_cfunobj;
  extern struct mkcl_cfun mk_cl_sublis_cfunobj;
  extern struct mkcl_cfun mk_cl_subst_cfunobj;
  extern struct mkcl_cfun mk_cl_tree_equal_cfunobj;
  extern struct mkcl_cfun mk_si_member1_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_dyn_cons_cfunobj;
  extern struct mkcl_cfun mk_si_trim_dynamic_cons_stack_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_load_source_cfunobj;
  extern struct mkcl_cfun mk_si_load_binary_cfunobj;
  extern struct mkcl_cfun mk_cl_load_cfunobj;

  extern MKCL_API mkcl_object mk_si_list_libraries(MKCL);

  extern struct mkcl_cfun mk_si_list_libraries_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_macroexpand_cfunobj;
  extern struct mkcl_cfun mk_cl_macroexpand_1_cfunobj;
  extern struct mkcl_cfun mk_cl_macro_function_cfunobj;
  ...
  extern struct mkcl_cfun mk_mkcl_argc_cfunobj;
  extern struct mkcl_cfun mk_si_gdb_cfunobj;
  extern struct mkcl_cfun mk_si_shutdown_mkcl_cfunobj;
  extern struct mkcl_cfun mk_si_shutdown_mkcl_threads_cfunobj;
  extern struct mkcl_cfun mk_mkcl_setenv_cfunobj;
  extern struct mkcl_cfun mk_mkcl_argv_cfunobj;
  extern struct mkcl_cfun mk_mkcl_getenv_cfunobj;
...
#define MKCL_UNLIMITED 0
  ...
  extern struct mkcl_cfun mk_si_register_shutdown_thread_cfunobj;
  extern struct mkcl_cfun mk_si_register_shutdown_watchdog_thread_cfunobj;
  extern struct mkcl_cfun mk_si_self_truename_cfunobj;
  extern struct mkcl_cfun mk_si_shutdown_in_progress_p_cfunobj;
  extern struct mkcl_cfun mk_si_shutdown_watchdog_thread_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_mapc_cfunobj;
  extern struct mkcl_cfun mk_cl_mapcan_cfunobj;
  extern struct mkcl_cfun mk_cl_mapcar_cfunobj;
  extern struct mkcl_cfun mk_cl_mapcon_cfunobj;
  extern struct mkcl_cfun mk_cl_mapl_cfunobj;
  extern struct mkcl_cfun mk_cl_maplist_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_values_list_cfunobj;
  extern struct mkcl_cfun mk_cl_values_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_X_cfunobj;
  extern struct mkcl_cfun mk_cl_P_cfunobj;
  extern struct mkcl_cfun mk_cl_M_cfunobj;
  extern struct mkcl_cfun mk_cl_N_cfunobj;
  extern struct mkcl_cfun mk_cl_gcd_cfunobj;
  extern struct mkcl_cfun mk_cl_lcm_cfunobj;
...
#define mk_cl_rationalize mk_cl_rational  /* FIXME. This short cut is too lazy. JCB */
  ...
  extern struct mkcl_cfun mk_cl_rational_cfunobj;
  extern struct mkcl_cfun mk_cl_rationalize_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_rem_cfunobj;
  extern struct mkcl_cfun mk_cl_mod_cfunobj;
  extern struct mkcl_cfun mk_cl_scale_float_cfunobj;
  extern struct mkcl_cfun mk_cl_decode_float_cfunobj;
  extern struct mkcl_cfun mk_cl_denominator_cfunobj;
  extern struct mkcl_cfun mk_cl_float_digits_cfunobj;
  extern struct mkcl_cfun mk_cl_float_precision_cfunobj;
  extern struct mkcl_cfun mk_cl_float_radix_cfunobj;
  extern struct mkcl_cfun mk_cl_imagpart_cfunobj;
  extern struct mkcl_cfun mk_cl_integer_decode_float_cfunobj;
  extern struct mkcl_cfun mk_cl_realpart_cfunobj;
  extern struct mkcl_cfun mk_cl_ceiling_cfunobj;
  extern struct mkcl_cfun mk_cl_complex_cfunobj;
  extern struct mkcl_cfun mk_cl_float_cfunobj;
  extern struct mkcl_cfun mk_cl_float_sign_cfunobj;
  extern struct mkcl_cfun mk_cl_floor_cfunobj;
  extern struct mkcl_cfun mk_cl_round_cfunobj;
  extern struct mkcl_cfun mk_cl_truncate_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_E_cfunobj;
  extern struct mkcl_cfun mk_cl_NE_cfunobj;
  extern struct mkcl_cfun mk_cl_L_cfunobj;
  extern struct mkcl_cfun mk_cl_G_cfunobj;
  extern struct mkcl_cfun mk_cl_GE_cfunobj;
  extern struct mkcl_cfun mk_cl_LE_cfunobj;
  extern struct mkcl_cfun mk_cl_max_cfunobj;
  extern struct mkcl_cfun mk_cl_min_cfunobj;
...
#define MKCL_BOOLSET		017
  ...
  extern struct mkcl_cfun mk_cl_lognand_cfunobj;
  extern struct mkcl_cfun mk_cl_lognor_cfunobj;
  extern struct mkcl_cfun mk_cl_logorc1_cfunobj;
  extern struct mkcl_cfun mk_cl_logorc2_cfunobj;
  extern struct mkcl_cfun mk_cl_ash_cfunobj;
  extern struct mkcl_cfun mk_cl_boole_cfunobj;
  extern struct mkcl_cfun mk_si_bit_array_op_cfunobj;
  extern struct mkcl_cfun mk_cl_logandc1_cfunobj;
  extern struct mkcl_cfun mk_cl_logandc2_cfunobj;
  extern struct mkcl_cfun mk_cl_logbitp_cfunobj;
  extern struct mkcl_cfun mk_cl_integer_length_cfunobj;
  extern struct mkcl_cfun mk_cl_logcount_cfunobj;
  extern struct mkcl_cfun mk_cl_lognot_cfunobj;
  extern struct mkcl_cfun mk_cl_logior_cfunobj;
  extern struct mkcl_cfun mk_cl_logxor_cfunobj;
  extern struct mkcl_cfun mk_cl_logand_cfunobj;
  extern struct mkcl_cfun mk_cl_logeqv_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_zerop_cfunobj;
  extern struct mkcl_cfun mk_cl_evenp_cfunobj;
  extern struct mkcl_cfun mk_cl_minusp_cfunobj;
  extern struct mkcl_cfun mk_cl_oddp_cfunobj;
  extern struct mkcl_cfun mk_cl_plusp_cfunobj;
  extern struct mkcl_cfun mk_si_float_nan_p_cfunobj;
  extern struct mkcl_cfun mk_si_float_infinity_p_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_random_state_p_cfunobj;
  extern struct mkcl_cfun mk_cl_random_cfunobj;
  extern struct mkcl_cfun mk_cl_make_random_state_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_cos_cfunobj;
  extern struct mkcl_cfun mk_cl_cosh_cfunobj;
  extern struct mkcl_cfun mk_cl_exp_cfunobj;
  extern struct mkcl_cfun mk_cl_sin_cfunobj;
  extern struct mkcl_cfun mk_cl_sinh_cfunobj;
  extern struct mkcl_cfun mk_cl_sqrt_cfunobj;
  extern struct mkcl_cfun mk_cl_tan_cfunobj;
  extern struct mkcl_cfun mk_cl_tanh_cfunobj;
  extern struct mkcl_cfun mk_si_log1p_cfunobj;
  extern struct mkcl_cfun mk_cl_atan_cfunobj;
  extern struct mkcl_cfun mk_cl_log_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_select_package_cfunobj;
  extern struct mkcl_cfun mk_cl_list_all_packages_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_package_cfunobj;
  extern struct mkcl_cfun mk_cl_find_package_cfunobj;
  extern struct mkcl_cfun mk_cl_package_name_cfunobj;
  extern struct mkcl_cfun mk_cl_package_nicknames_cfunobj;
  extern struct mkcl_cfun mk_cl_package_shadowing_symbols_cfunobj;
  extern struct mkcl_cfun mk_cl_package_use_list_cfunobj;
  extern struct mkcl_cfun mk_cl_package_used_by_list_cfunobj;
  extern struct mkcl_cfun mk_si_package_hash_tables_cfunobj;
  extern struct mkcl_cfun mk_si_close_package_cfunobj;
  extern struct mkcl_cfun mk_si_reopen_package_cfunobj;
  extern struct mkcl_cfun mk_si_package_closed_p_cfunobj;
  extern struct mkcl_cfun mk_cl_export_cfunobj;
  extern struct mkcl_cfun mk_cl_find_symbol_cfunobj;
  extern struct mkcl_cfun mk_cl_import_cfunobj;
  extern struct mkcl_cfun mk_cl_intern_cfunobj;
  extern struct mkcl_cfun mk_cl_make_package_cfunobj;
  extern struct mkcl_cfun mk_cl_rename_package_cfunobj;
  extern struct mkcl_cfun mk_cl_shadow_cfunobj;
  extern struct mkcl_cfun mk_cl_shadowing_import_cfunobj;
  extern struct mkcl_cfun mk_cl_unexport_cfunobj;
  extern struct mkcl_cfun mk_cl_unintern_cfunobj;
  extern struct mkcl_cfun mk_cl_use_package_cfunobj;
  extern struct mkcl_cfun mk_cl_unuse_package_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_packages_in_waiting_cfunobj;
  extern struct mkcl_cfun mk_si_coerce_to_package_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_pathname_match_p_cfunobj;
  extern struct mkcl_cfun mk_cl_directory_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_file_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_host_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_logical_pathname_cfunobj;
  extern struct mkcl_cfun mk_cl_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_version_cfunobj;
  extern struct mkcl_cfun mk_cl_pathnamep_cfunobj;
  extern struct mkcl_cfun mk_mkcl_logical_pathname_p_cfunobj;
  extern struct mkcl_cfun mk_cl_enough_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_make_pathname_cfunobj;
  extern struct mkcl_cfun mk_cl_merge_pathnames_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_device_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_directory_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_host_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_name_cfunobj;
  extern struct mkcl_cfun mk_cl_pathname_type_cfunobj;
  extern struct mkcl_cfun mk_cl_parse_namestring_cfunobj;
  extern struct mkcl_cfun mk_cl_translate_pathname_cfunobj;
  extern struct mkcl_cfun mk_cl_translate_logical_pathname_cfunobj;
  extern struct mkcl_cfun mk_cl_wild_pathname_p_cfunobj;
  extern struct mkcl_cfun mk_si_pathname_translations_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_coerce_to_filename_cfunobj;
  ...
  extern struct mkcl_cfun mk_mkcl_pathname_complete_p_cfunobj;
  extern struct mkcl_cfun mk_mkcl_meld_pathnames_cfunobj;
...
#define mk_cl_not mk_cl_null
  ...
  extern struct mkcl_cfun mk_cl_identity_cfunobj;
  extern struct mkcl_cfun mk_cl_eq_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_floatp_cfunobj;
  extern struct mkcl_cfun mk_cl_functionp_cfunobj;
  extern struct mkcl_cfun mk_cl_integerp_cfunobj;
  extern struct mkcl_cfun mk_cl_listp_cfunobj;
  extern struct mkcl_cfun mk_cl_not_cfunobj;
  extern struct mkcl_cfun mk_cl_null_cfunobj;
  extern struct mkcl_cfun mk_cl_numberp_cfunobj;
  extern struct mkcl_cfun mk_cl_numerator_cfunobj;
  extern struct mkcl_cfun mk_cl_packagep_cfunobj;
  extern struct mkcl_cfun mk_cl_rationalp_cfunobj;
  extern struct mkcl_cfun mk_cl_realp_cfunobj;
  extern struct mkcl_cfun mk_cl_simple_bit_vector_p_cfunobj;
  extern struct mkcl_cfun mk_cl_simple_string_p_cfunobj;
  extern struct mkcl_cfun mk_cl_simple_vector_p_cfunobj;
  extern struct mkcl_cfun mk_cl_stringp_cfunobj;
  extern struct mkcl_cfun mk_cl_symbolp_cfunobj;
  extern struct mkcl_cfun mk_cl_vectorp_cfunobj;
  extern struct mkcl_cfun mk_mkcl_fixnump_cfunobj;
  extern struct mkcl_cfun mk_si_bytecodep_cfunobj;
  extern struct mkcl_cfun mk_si_simple_base_string_p_cfunobj;

  extern MKCL_API mkcl_object mk_si_unbound_value_p(MKCL, mkcl_object arg);

  extern struct mkcl_cfun mk_si_unbound_value_p_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_write_byte_cfunobj;
  extern struct mkcl_cfun mk_cl_write_sequence_cfunobj;
  extern struct mkcl_cfun mk_si_write_object_cfunobj;
  extern struct mkcl_cfun mk_cl_write_cfunobj;
  extern struct mkcl_cfun mk_si_write_ugly_object_cfunobj;
  extern struct mkcl_cfun mk_cl_finish_output_cfunobj;
  extern struct mkcl_cfun mk_cl_force_output_cfunobj;
  extern struct mkcl_cfun mk_cl_fresh_line_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_cfunobj;
  extern struct mkcl_cfun mk_cl_prin1_cfunobj;
  extern struct mkcl_cfun mk_cl_princ_cfunobj;
  extern struct mkcl_cfun mk_cl_print_cfunobj;
  extern struct mkcl_cfun mk_cl_terpri_cfunobj;
  extern struct mkcl_cfun mk_cl_write_char_cfunobj;
  extern struct mkcl_cfun mk_cl_write_line_cfunobj;
  extern struct mkcl_cfun mk_cl_write_string_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_listen_cfunobj;
  extern struct mkcl_cfun mk_si_standard_readtable_cfunobj;
  extern struct mkcl_cfun mk_si_get_buffer_string_cfunobj;
  extern struct mkcl_cfun mk_si_readtable_case_set_cfunobj;
  extern struct mkcl_cfun mk_si_read_object_or_ignore_cfunobj;
  extern struct mkcl_cfun mk_cl_readtable_case_cfunobj;
  extern struct mkcl_cfun mk_cl_readtablep_cfunobj;
  extern struct mkcl_cfun mk_si_fast_read_from_base_string_cfunobj;
  extern struct mkcl_cfun mk_cl_clear_input_cfunobj;
  extern struct mkcl_cfun mk_cl_clear_output_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_readtable_cfunobj;
  extern struct mkcl_cfun mk_cl_get_dispatch_macro_character_cfunobj;
  extern struct mkcl_cfun mk_cl_get_macro_character_cfunobj;
  extern struct mkcl_cfun mk_cl_parse_integer_cfunobj;
  extern struct mkcl_cfun mk_cl_peek_char_cfunobj;
  extern struct mkcl_cfun mk_cl_read_cfunobj;
  extern struct mkcl_cfun mk_cl_read_byte_cfunobj;
  extern struct mkcl_cfun mk_cl_read_char_cfunobj;
  extern struct mkcl_cfun mk_cl_read_char_no_hang_cfunobj;
  extern struct mkcl_cfun mk_cl_read_delimited_list_cfunobj;
  extern struct mkcl_cfun mk_cl_read_line_cfunobj;
  extern struct mkcl_cfun mk_cl_read_preserving_whitespace_cfunobj;
  extern struct mkcl_cfun mk_cl_read_sequence_cfunobj;
  extern struct mkcl_cfun mk_cl_set_macro_character_cfunobj;
  extern struct mkcl_cfun mk_cl_set_syntax_from_char_cfunobj;
  extern struct mkcl_cfun mk_cl_set_dispatch_macro_character_cfunobj;
  extern struct mkcl_cfun mk_cl_unread_char_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_fboundp_cfunobj;
  extern struct mkcl_cfun mk_cl_fdefinition_cfunobj;
  extern struct mkcl_cfun mk_cl_special_operator_p_cfunobj;
  extern struct mkcl_cfun mk_cl_symbol_function_cfunobj;
  extern struct mkcl_cfun mk_cl_symbol_value_cfunobj;
  extern struct mkcl_cfun mk_si_coerce_to_function_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_elt_cfunobj;
  extern struct mkcl_cfun mk_si_elt_set_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_seq_cfunobj;
  extern struct mkcl_cfun mk_cl_length_cfunobj;
  extern struct mkcl_cfun mk_cl_reverse_cfunobj;
  extern struct mkcl_cfun mk_cl_nreverse_cfunobj;
  extern struct mkcl_cfun mk_cl_subseq_cfunobj;
...
#define mk_si_schar_set mk_si_char_set
  ...
  extern struct mkcl_cfun mk_cl_char_cfunobj;
  extern struct mkcl_cfun mk_si_char_set_cfunobj;
  extern struct mkcl_cfun mk_cl_schar_cfunobj;
  extern struct mkcl_cfun mk_si_schar_set_cfunobj;
  extern struct mkcl_cfun mk_cl_string_cfunobj;
  extern struct mkcl_cfun mk_cl_string_equal_cfunobj;
  extern struct mkcl_cfun mk_cl_string_left_trim_cfunobj;
  extern struct mkcl_cfun mk_cl_string_right_trim_cfunobj;
  extern struct mkcl_cfun mk_cl_string_trim_cfunobj;
  extern struct mkcl_cfun mk_si_copy_to_simple_base_string_cfunobj;
  extern struct mkcl_cfun mk_si_copy_to_simple_string_cfunobj;
  extern struct mkcl_cfun mk_cl_make_string_cfunobj;
  extern struct mkcl_cfun mk_cl_nstring_capitalize_cfunobj;
  extern struct mkcl_cfun mk_cl_nstring_downcase_cfunobj;
  extern struct mkcl_cfun mk_cl_nstring_upcase_cfunobj;
  extern struct mkcl_cfun mk_cl_string_downcase_cfunobj;
  extern struct mkcl_cfun mk_cl_string_capitalize_cfunobj;
  extern struct mkcl_cfun mk_cl_string_greaterp_cfunobj;
  extern struct mkcl_cfun mk_cl_string_lessp_cfunobj;
  extern struct mkcl_cfun mk_cl_string_not_equal_cfunobj;
  extern struct mkcl_cfun mk_cl_string_not_greaterp_cfunobj;
  extern struct mkcl_cfun mk_cl_string_not_lessp_cfunobj;
  extern struct mkcl_cfun mk_cl_string_upcase_cfunobj;
  extern struct mkcl_cfun mk_cl_stringE_cfunobj;
  extern struct mkcl_cfun mk_cl_stringG_cfunobj;
  extern struct mkcl_cfun mk_cl_stringGE_cfunobj;
  extern struct mkcl_cfun mk_cl_stringL_cfunobj;
  extern struct mkcl_cfun mk_cl_stringLE_cfunobj;
  extern struct mkcl_cfun mk_cl_stringNE_cfunobj;
  extern struct mkcl_cfun mk_si_concatenate_base_strings_cfunobj;
  extern struct mkcl_cfun mk_si_concatenate_strings_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_utf_8_char_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8E_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_push_extend_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_p_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_length_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_as_is_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8_last_cfunobj;
  extern struct mkcl_cfun mk_si_utf_8Plus_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_utf_16_char_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16Plus_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_push_extend_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_p_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_length_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_as_is_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16E_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16_last_cfunobj;
  extern struct mkcl_cfun mk_si_utf_16Plus_cfunobj;
...
# define MKCL_OSSTRINGP(str) (MKCL_UTF_8_P(str) || MKCL_BASE_STRING_P(str))
  ...
  extern struct mkcl_cfun mk_mkcl_octets_cfunobj;
  extern struct mkcl_cfun mk_mkcl_double_octets_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_structure_set_cfunobj;
  extern struct mkcl_cfun mk_si_structure_ref_cfunobj;
  extern struct mkcl_cfun mk_si_structure_subtype_p_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_structure_cfunobj;
  extern struct mkcl_cfun mk_si_structure_name_cfunobj;
  extern struct mkcl_cfun mk_si_structure_length_cfunobj;
  extern struct mkcl_cfun mk_si_structurep_cfunobj;
  extern struct mkcl_cfun mk_si_make_structure_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_put_f_cfunobj;
  extern struct mkcl_cfun mk_si_putprop_cfunobj;
  extern struct mkcl_cfun mk_cl_remprop_cfunobj;
  extern struct mkcl_cfun mk_cl_get_properties_cfunobj;
  extern struct mkcl_cfun mk_si_Xmake_constant_cfunobj;
  extern struct mkcl_cfun mk_si_rem_f_cfunobj;
  extern struct mkcl_cfun mk_si_set_symbol_plist_cfunobj;
  extern struct mkcl_cfun mk_cl_keywordp_cfunobj;
  extern struct mkcl_cfun mk_cl_make_symbol_cfunobj;
  extern struct mkcl_cfun mk_cl_symbol_name_cfunobj;
  extern struct mkcl_cfun mk_cl_symbol_package_cfunobj;
  extern struct mkcl_cfun mk_cl_symbol_plist_cfunobj;
  extern struct mkcl_cfun mk_si_Xmake_special_cfunobj;
  extern struct mkcl_cfun mk_cl_copy_symbol_cfunobj;
  extern struct mkcl_cfun mk_cl_gensym_cfunobj;
  extern struct mkcl_cfun mk_cl_gentemp_cfunobj;
  extern struct mkcl_cfun mk_cl_get_cfunobj;
  extern struct mkcl_cfun mk_cl_getf_cfunobj;
  extern struct mkcl_cfun mk_si_put_properties_cfunobj;
  ...
  extern struct mkcl_cfun mk_mt_all_threads_cfunobj;
  extern struct mkcl_cfun mk_mt_abandon_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_terminate_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_yield_cfunobj;
  extern struct mkcl_cfun mk_mt_show_sigmask_cfunobj;
  extern struct mkcl_cfun mk_mt_reset_sigmask_cfunobj;
  extern struct mkcl_cfun mk_mt_block_signals_cfunobj;
  extern struct mkcl_cfun mk_mt_unblock_signals_cfunobj;
  extern struct mkcl_cfun mk_mt_make_rwlock_cfunobj;
  extern struct mkcl_cfun mk_mt_make_condition_variable_cfunobj;
  extern struct mkcl_cfun mk_mt_current_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_cancel_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_abort_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_exit_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_active_p_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_enable_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_kill_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_detach_cfunobj;
  extern struct mkcl_cfun mk_mt_detach_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_join_cfunobj;
  extern struct mkcl_cfun mk_mt_join_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_name_cfunobj;
  extern struct mkcl_cfun mk_mt_recursive_lock_p_cfunobj;
  extern struct mkcl_cfun mk_mt_lock_name_cfunobj;
  extern struct mkcl_cfun mk_mt_lock_holder_cfunobj;
  extern struct mkcl_cfun mk_mt_giveup_lock_cfunobj;
  extern struct mkcl_cfun mk_mt_semaphore_count_cfunobj;
  extern struct mkcl_cfun mk_mt_condition_signal_cfunobj;
  extern struct mkcl_cfun mk_mt_condition_broadcast_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_plist_cfunobj;
  extern struct mkcl_cfun mk_mt_request_thread_shutdown_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_shutdown_requested_p_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_status_cfunobj;
  extern struct mkcl_cfun mk_mt_make_thread_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_preset_cfunobj;
  extern struct mkcl_cfun mk_mt_thread_run_function_cfunobj;
  extern struct mkcl_cfun mk_mt_make_lock_cfunobj;
  extern struct mkcl_cfun mk_mt_get_lock_cfunobj;
  extern struct mkcl_cfun mk_mt_giveup_rwlock_cfunobj;
  extern struct mkcl_cfun mk_mt_get_read_rwlock_cfunobj;
  extern struct mkcl_cfun mk_mt_get_write_rwlock_cfunobj;
  extern struct mkcl_cfun mk_mt_make_semaphore_cfunobj;
  extern struct mkcl_cfun mk_mt_semaphore_signal_cfunobj;
  extern struct mkcl_cfun mk_mt_semaphore_wait_cfunobj;
  extern struct mkcl_cfun mk_mt_condition_wait_cfunobj;
  extern struct mkcl_cfun mk_mt_interrupt_thread_cfunobj;
  ...
  extern struct mkcl_cfun mk_mt_set_thread_plist_cfunobj;
...
#define MKCL_THREAD_NORMAL_EXIT (0)
  ...
  extern struct mkcl_cfun mk_si_non_interactive_thread_debugger_trap_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_sleep_cfunobj;
  extern struct mkcl_cfun mk_cl_get_internal_real_time_cfunobj;
  extern struct mkcl_cfun mk_cl_get_internal_run_time_cfunobj;
  extern struct mkcl_cfun mk_cl_get_universal_time_cfunobj;
  extern struct mkcl_cfun mk_si_get_local_time_zone_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_type_of_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_truename_cfunobj;
  extern struct mkcl_cfun mk_cl_rename_file_cfunobj;
  extern struct mkcl_cfun mk_mkcl_getpid_cfunobj;
  extern struct mkcl_cfun mk_mkcl_getuid_cfunobj;
  extern struct mkcl_cfun mk_mkcl_gettid_cfunobj;
  extern struct mkcl_cfun mk_mkcl_mkdir_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_file_cfunobj;
  extern struct mkcl_cfun mk_cl_file_author_cfunobj;
  extern struct mkcl_cfun mk_cl_file_write_date_cfunobj;
  extern struct mkcl_cfun mk_cl_probe_file_cfunobj;
  extern struct mkcl_cfun mk_mkcl_rmdir_cfunobj;
  extern struct mkcl_cfun mk_cl_directory_cfunobj;
  extern struct mkcl_cfun mk_cl_user_homedir_pathname_cfunobj;
  extern struct mkcl_cfun mk_mkcl_chdir_cfunobj;
  extern struct mkcl_cfun mk_si_file_kind_cfunobj;
  extern struct mkcl_cfun mk_mkcl_getcwd_cfunobj;
  extern struct mkcl_cfun mk_mkcl_mkstemp_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_get_SYS_library_pathname_cfunobj;
  extern struct mkcl_cfun mk_mkcl_copy_file_cfunobj;
  ...
  extern struct mkcl_cfun mk_mkcl_probe_file_p_cfunobj;
  extern struct mkcl_cfun mk_mkcl_stream_filename_cfunobj;
...
#define MKCL_GC_NO_INTR(env, expr) {			\
  ...
  extern struct mkcl_cfun mk_mt_try_to_wake_up_thread_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_initial_floating_point_exception_set_cfunobj;
  extern struct mkcl_cfun mk_si_all_enabled_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_all_raised_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_clear_all_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_disable_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_enable_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_fpe_enabled_p_cfunobj;
  extern struct mkcl_cfun mk_si_raise_fpe_cfunobj;
  extern struct mkcl_cfun mk_si_fpe_raised_p_cfunobj;
  extern struct mkcl_cfun mk_si_clear_fpe_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_signum_to_signal_name_cfunobj;
  extern struct mkcl_cfun mk_si_do_sigsegv_cfunobj;
  extern struct mkcl_cfun mk_si_objnull_cfunobj;
  extern struct mkcl_cfun mk_si_objnull_value_p_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_display_signal_dispositions_cfunobj;
  extern struct mkcl_cfun mk_si_install_sigsegv_monitor_cfunobj;
  extern struct mkcl_cfun mk_si_setup_for_gdb_cfunobj;
  ...
  extern struct mkcl_cfun mk_mkcl_process_argv_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_id_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_p_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_command_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_detached_p_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_error_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_input_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_output_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_plist_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_status_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_exit_code_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_from_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_to_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_process_error_from_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_set_process_to_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_set_process_from_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_set_process_plist_cfunobj;
  extern struct mkcl_cfun mk_mkcl_set_process_error_from_worker_cfunobj;
  extern struct mkcl_cfun mk_mkcl_make_pipe_cfunobj;
  extern struct mkcl_cfun mk_si_uname_cfunobj;
  extern struct mkcl_cfun mk_mkcl_system_cfunobj;
  extern struct mkcl_cfun mk_mkcl_join_process_cfunobj;
  extern struct mkcl_cfun mk_mkcl_detach_process_cfunobj;
  extern struct mkcl_cfun mk_mkcl_run_command_cfunobj;
  extern struct mkcl_cfun mk_mkcl_run_program_1_cfunobj;
  extern struct mkcl_cfun mk_mkcl_terminate_process_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_list_all_children_cfunobj;
  extern struct mkcl_cfun mk_si_trace_specials_cfunobj;
  extern struct mkcl_cfun mk_si_untrace_specials_cfunobj;
  ...
  extern struct mkcl_cfun mk_mkcl_base_char_p_cfunobj;
  extern struct mkcl_cfun mk_si_base_string_p_cfunobj;
  extern struct mkcl_cfun mk_si_coerce_to_base_string_cfunobj;
  extern struct mkcl_cfun mk_si_coerce_to_character_string_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_make_array_cfunobj;
  extern struct mkcl_cfun mk_cl_vector_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_and_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_andc1_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_andc2_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_eqv_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_ior_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_nand_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_nor_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_not_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_orc1_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_orc2_cfunobj;
  extern struct mkcl_cfun mk_cl_bit_xor_cfunobj;
  extern struct mkcl_cfun mk_cl_adjust_array_cfunobj;
  extern struct mkcl_cfun mk_cl_array_in_bounds_p_cfunobj;
  extern struct mkcl_cfun mk_cl_sbit_cfunobj;
  extern struct mkcl_cfun mk_cl_vector_push_extend_cfunobj;
  extern struct mkcl_cfun mk_cl_array_dimensions_cfunobj;
  extern struct mkcl_cfun mk_cl_vector_pop_cfunobj;
  extern struct mkcl_cfun mk_cl_vector_push_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_mkcl_version_cfunobj;
  extern struct mkcl_cfun mk_si_mkcl_major_version_cfunobj;
  extern struct mkcl_cfun mk_si_mkcl_minor_version_cfunobj;
  extern struct mkcl_cfun mk_si_mkcl_patch_level_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_y_or_n_p_cfunobj;
  extern struct mkcl_cfun mk_cl_yes_or_no_p_cfunobj;
  extern struct mkcl_cfun mk_cl_read_from_string_cfunobj;
  extern struct mkcl_cfun mk_cl_write_to_string_cfunobj;
  extern struct mkcl_cfun mk_mkcl_prin1_to_base_string_cfunobj;
  extern struct mkcl_cfun mk_mkcl_princ_to_base_string_cfunobj;
  extern struct mkcl_cfun mk_mkcl_write_to_base_string_cfunobj;
  extern struct mkcl_cfun mk_cl_prin1_to_string_cfunobj;
  extern struct mkcl_cfun mk_cl_princ_to_string_cfunobj;
  extern struct mkcl_cfun mk_mkcl_run_program_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_union_cfunobj;
  extern struct mkcl_cfun mk_cl_nunion_cfunobj;
  extern struct mkcl_cfun mk_cl_intersection_cfunobj;
  extern struct mkcl_cfun mk_cl_assoc_if_cfunobj;
  extern struct mkcl_cfun mk_cl_assoc_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_member_if_cfunobj;
  extern struct mkcl_cfun mk_cl_member_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubst_if_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubst_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_nintersection_cfunobj;
  extern struct mkcl_cfun mk_cl_nset_difference_cfunobj;
  extern struct mkcl_cfun mk_cl_nset_exclusive_or_cfunobj;
  extern struct mkcl_cfun mk_cl_rassoc_if_cfunobj;
  extern struct mkcl_cfun mk_cl_rassoc_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_set_difference_cfunobj;
  extern struct mkcl_cfun mk_cl_set_exclusive_or_cfunobj;
  extern struct mkcl_cfun mk_cl_subsetp_cfunobj;
  extern struct mkcl_cfun mk_cl_subst_if_cfunobj;
  extern struct mkcl_cfun mk_cl_subst_if_not_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_load_logical_pathname_translations_cfunobj;
  extern struct mkcl_cfun mk_cl_logical_pathname_translations_cfunobj;
  extern struct mkcl_cfun mk_cl_encode_universal_time_cfunobj;
  extern struct mkcl_cfun mk_cl_decode_universal_time_cfunobj;
  extern struct mkcl_cfun mk_cl_get_decoded_time_cfunobj;
  extern struct mkcl_cfun mk_cl_ensure_directories_exist_cfunobj;

  extern struct mkcl_cfun mk_si_all_logical_pathname_translations_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_provide_cfunobj;
  extern struct mkcl_cfun mk_cl_require_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_isqrt_cfunobj;
  extern struct mkcl_cfun mk_cl_phase_cfunobj;
  extern struct mkcl_cfun mk_cl_signum_cfunobj;
  extern struct mkcl_cfun mk_cl_fceiling_cfunobj;
  extern struct mkcl_cfun mk_cl_ffloor_cfunobj;
  extern struct mkcl_cfun mk_cl_fround_cfunobj;
  extern struct mkcl_cfun mk_cl_ftruncate_cfunobj;
  extern struct mkcl_cfun mk_cl_acos_cfunobj;
  extern struct mkcl_cfun mk_cl_acosh_cfunobj;
  extern struct mkcl_cfun mk_cl_asin_cfunobj;
  extern struct mkcl_cfun mk_cl_asinh_cfunobj;
  extern struct mkcl_cfun mk_cl_atanh_cfunobj;
  extern struct mkcl_cfun mk_cl_byte_cfunobj;
  extern struct mkcl_cfun mk_cl_byte_position_cfunobj;
  extern struct mkcl_cfun mk_cl_byte_size_cfunobj;
  extern struct mkcl_cfun mk_cl_cis_cfunobj;
  extern struct mkcl_cfun mk_cl_ldb_cfunobj;
  extern struct mkcl_cfun mk_cl_ldb_test_cfunobj;
  extern struct mkcl_cfun mk_cl_dpb_cfunobj;
  extern struct mkcl_cfun mk_cl_deposit_field_cfunobj;
  extern struct mkcl_cfun mk_cl_logtest_cfunobj;
  extern struct mkcl_cfun mk_cl_mask_field_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_apropos_cfunobj;
  extern struct mkcl_cfun mk_cl_apropos_list_cfunobj;
  extern struct mkcl_cfun mk_cl_find_all_symbols_cfunobj;
  extern struct mkcl_cfun mk_si_find_relative_package_cfunobj;
  extern struct mkcl_cfun mk_si_package_parent_cfunobj;
  extern struct mkcl_cfun mk_si_package_children_cfunobj;
  ...
  extern struct mkcl_cfun mk_si_subclassp_cfunobj;
  extern struct mkcl_cfun mk_si_of_class_p_cfunobj;
  extern struct mkcl_cfun mk_si_do_deftype_cfunobj;
  extern struct mkcl_cfun mk_cl_upgraded_array_element_type_cfunobj;
  extern struct mkcl_cfun mk_cl_upgraded_complex_part_type_cfunobj;
  extern struct mkcl_cfun mk_cl_typep_cfunobj;
  extern struct mkcl_cfun mk_cl_subtypep_cfunobj;
  extern struct mkcl_cfun mk_cl_coerce_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_make_sequence_cfunobj;
  extern struct mkcl_cfun mk_cl_map_cfunobj;
  extern struct mkcl_cfun mk_cl_map_into_cfunobj;
  extern struct mkcl_cfun mk_cl_every_cfunobj;
  extern struct mkcl_cfun mk_cl_concatenate_cfunobj;
  extern struct mkcl_cfun mk_cl_notany_cfunobj;
  extern struct mkcl_cfun mk_cl_notevery_cfunobj;
  extern struct mkcl_cfun mk_cl_some_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_reduce_cfunobj;
  extern struct mkcl_cfun mk_cl_replace_cfunobj;
  extern struct mkcl_cfun mk_cl_count_cfunobj;
  extern struct mkcl_cfun mk_cl_count_if_cfunobj;
  extern struct mkcl_cfun mk_cl_count_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_if_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_delete_duplicates_cfunobj;
  extern struct mkcl_cfun mk_cl_fill_cfunobj;
  extern struct mkcl_cfun mk_cl_find_cfunobj;
  extern struct mkcl_cfun mk_cl_find_if_cfunobj;
  extern struct mkcl_cfun mk_cl_find_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_merge_cfunobj;
  extern struct mkcl_cfun mk_cl_mismatch_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubstitute_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubstitute_if_cfunobj;
  extern struct mkcl_cfun mk_cl_nsubstitute_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_position_cfunobj;
  extern struct mkcl_cfun mk_cl_position_if_cfunobj;
  extern struct mkcl_cfun mk_cl_position_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_remove_cfunobj;
  extern struct mkcl_cfun mk_cl_remove_duplicates_cfunobj;
  extern struct mkcl_cfun mk_cl_remove_if_cfunobj;
  extern struct mkcl_cfun mk_cl_remove_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_search_cfunobj;
  extern struct mkcl_cfun mk_cl_sort_cfunobj;
  extern struct mkcl_cfun mk_cl_stable_sort_cfunobj;
  extern struct mkcl_cfun mk_cl_substitute_cfunobj;
  extern struct mkcl_cfun mk_cl_substitute_if_cfunobj;
  extern struct mkcl_cfun mk_cl_substitute_if_not_cfunobj;
  extern struct mkcl_cfun mk_cl_constantly_cfunobj;
  extern struct mkcl_cfun mk_cl_complement_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_copy_pprint_dispatch_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_dispatch_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_fill_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_indent_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_linear_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_newline_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_tab_cfunobj;
  extern struct mkcl_cfun mk_cl_pprint_tabular_cfunobj;
  extern struct mkcl_cfun mk_cl_set_pprint_dispatch_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_method_combination_error_cfunobj;
  extern struct mkcl_cfun mk_cl_invalid_method_error_cfunobj;
  ...
  extern struct mkcl_cfun mk_cl_continue_cfunobj;
