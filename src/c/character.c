...
struct mkcl_cfun mk_cl_standard_char_p_cfunobj = MKCL_CFUN1(mk_cl_standard_char_p, (mkcl_object) &MK_CL_standard_char_p);
...
struct mkcl_cfun mk_cl_graphic_char_p_cfunobj = MKCL_CFUN1(mk_cl_graphic_char_p, (mkcl_object) &MK_CL_graphic_char_p);
...
struct mkcl_cfun mk_cl_alpha_char_p_cfunobj = MKCL_CFUN1(mk_cl_alpha_char_p, (mkcl_object) &MK_CL_alpha_char_p);
...
struct mkcl_cfun mk_cl_upper_case_p_cfunobj = MKCL_CFUN1(mk_cl_upper_case_p, (mkcl_object) &MK_CL_upper_case_p);
...
struct mkcl_cfun mk_cl_lower_case_p_cfunobj = MKCL_CFUN1(mk_cl_lower_case_p, (mkcl_object) &MK_CL_lower_case_p);
...
struct mkcl_cfun mk_cl_both_case_p_cfunobj = MKCL_CFUN1(mk_cl_both_case_p, (mkcl_object) &MK_CL_both_case_p);
...
struct mkcl_cfun mk_cl_digit_char_p_cfunobj = MKCL_CFUN_VA(mk_cl_digit_char_p, (mkcl_object) &MK_CL_digit_char_p);
...
mkcl_object mk_cl_digit_char_p(MKCL, mkcl_narg narg, mkcl_object c, ...)
{
  mkcl_call_stack_check(env);
  {
    ...
    MKCL_RECEIVE_1_OPTIONAL_ARGUMENT(env, (mkcl_object) &MK_CL_digit_char_p, narg, 1, c, &radix);
    {
      mkcl_word basis = mkcl_fixnum_in_range(env, (mkcl_object) &MK_CL_digit_char_p,"radix", radix, 2, 36);
...
struct mkcl_cfun mk_cl_alphanumericp_cfunobj = MKCL_CFUN1(mk_cl_alphanumericp, (mkcl_object) &MK_CL_alphanumericp);
...
struct mkcl_cfun mk_cl_charE_cfunobj = MKCL_CFUN_VA(mk_cl_charE, (mkcl_object) &MK_CL_charE);

mkcl_object mk_cl_charE(MKCL, mkcl_narg narg, mkcl_object c, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charE, 1, narg, c, cs);
...
struct mkcl_cfun mk_cl_charNE_cfunobj = MKCL_CFUN_VA(mk_cl_charNE, (mkcl_object) &MK_CL_charNE);
...
mkcl_object mk_cl_charNE(MKCL, const mkcl_narg narg, ...)
{
  ...
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charE, 0, narg, narg, cs);

    /* INV: mkcl_char_eq() checks types of its arguments */
    if (narg == 0)
      mkcl_FEwrong_num_arguments(env, (mkcl_object) &MK_CL_charNE, 1, -1, 0);
    c = mkcl_va_arg(cs);
    for (i = 2; i<=narg; i++) {
      mkcl_va_list ds;
...
struct mkcl_cfun mk_cl_charL_cfunobj = MKCL_CFUN_VA(mk_cl_charL, (mkcl_object) &MK_CL_charL);

mkcl_object mk_cl_charL(MKCL, const mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charL, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_charG_cfunobj = MKCL_CFUN_VA(mk_cl_charG, (mkcl_object) &MK_CL_charG);

mkcl_object mk_cl_charG(MKCL, const mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charG, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_charLE_cfunobj = MKCL_CFUN_VA(mk_cl_charLE, (mkcl_object) &MK_CL_charLE);

mkcl_object mk_cl_charLE(MKCL, const mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charLE, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_charGE_cfunobj = MKCL_CFUN_VA(mk_cl_charGE, (mkcl_object) &MK_CL_charGE);

mkcl_object mk_cl_charGE(MKCL, const mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_charGE, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_char_equal_cfunobj = MKCL_CFUN_VA(mk_cl_char_equal, (mkcl_object) &MK_CL_char_equal);
...
mkcl_object mk_cl_char_equal(MKCL, mkcl_narg narg, mkcl_object c, ...)
{
  ...
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_equal, 1, narg, c, cs);
...
struct mkcl_cfun mk_cl_char_not_equal_cfunobj = MKCL_CFUN_VA(mk_cl_char_not_equal, (mkcl_object) &MK_CL_char_not_equal);
...
mkcl_object mk_cl_char_not_equal(MKCL, mkcl_narg narg, ...)
{
  ...
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_not_equal, 0, narg, narg, cs);

    /* INV: mkcl_char_equal() checks the type of its arguments */
    if (narg == 0)
      mkcl_FEwrong_num_arguments(env, (mkcl_object) &MK_CL_char_not_equal, 1, -1, narg);
    c = mkcl_va_arg(cs);
    for (i = 2;  i<=narg;  i++) {
      mkcl_va_list ds;
      mkcl_va_start(env, ds, narg, narg, 0);
...
struct mkcl_cfun mk_cl_char_lessp_cfunobj = MKCL_CFUN_VA(mk_cl_char_lessp, (mkcl_object) &MK_CL_char_lessp);

mkcl_object mk_cl_char_lessp(MKCL, mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_lessp, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_char_greaterp_cfunobj = MKCL_CFUN_VA(mk_cl_char_greaterp, (mkcl_object) &MK_CL_char_greaterp);

mkcl_object mk_cl_char_greaterp(MKCL, mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_greaterp, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_char_not_greaterp_cfunobj = MKCL_CFUN_VA(mk_cl_char_not_greaterp, (mkcl_object) &MK_CL_char_not_greaterp);

mkcl_object mk_cl_char_not_greaterp(MKCL, mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_not_greaterp, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_char_not_lessp_cfunobj = MKCL_CFUN_VA(mk_cl_char_not_lessp, (mkcl_object) &MK_CL_char_not_lessp);

mkcl_object mk_cl_char_not_lessp(MKCL, mkcl_narg narg, ...)
{
  mkcl_call_stack_check(env);
  {
    mkcl_setup_for_rest(env, (mkcl_object) &MK_CL_char_not_lessp, 0, narg, narg, args);
...
struct mkcl_cfun mk_cl_character_cfunobj = MKCL_CFUN1(mk_cl_character, (mkcl_object) &MK_CL_character);
...
struct mkcl_cfun mk_cl_char_code_cfunobj = MKCL_CFUN1(mk_cl_char_code, (mkcl_object) &MK_CL_char_code);
...
struct mkcl_cfun mk_cl_code_char_cfunobj = MKCL_CFUN1(mk_cl_code_char, (mkcl_object) &MK_CL_code_char);
...
struct mkcl_cfun mk_cl_char_upcase_cfunobj = MKCL_CFUN1(mk_cl_char_upcase, (mkcl_object) &MK_CL_char_upcase);
...
struct mkcl_cfun mk_cl_char_downcase_cfunobj = MKCL_CFUN1(mk_cl_char_downcase, (mkcl_object) &MK_CL_char_downcase);
...
struct mkcl_cfun mk_cl_digit_char_cfunobj = MKCL_CFUN_VA(mk_cl_digit_char, (mkcl_object) &MK_CL_digit_char);
...
mkcl_object mk_cl_digit_char(MKCL, mkcl_narg narg, mkcl_object weight, ...)
{
  ...
  {
    mkcl_object radix = MKCL_MAKE_FIXNUM(10);
    MKCL_RECEIVE_1_OPTIONAL_ARGUMENT(env, (mkcl_object) &MK_CL_digit_char, narg, 1, weight, &radix);

    {
      mkcl_word basis = mkcl_fixnum_in_range(env, (mkcl_object) &MK_CL_digit_char,"radix",radix,2,36);
    ...
    AGAIN:
      ...
      case mkcl_t_bignum:
        break;
      default:
        weight = mkcl_type_error(env, (mkcl_object) &MK_CL_digit_char,"weight",weight,(mkcl_object) &MK_CL_integer);
        goto AGAIN;
      }
...
struct mkcl_cfun mk_cl_char_int_cfunobj = MKCL_CFUN1(mk_cl_char_int, (mkcl_object) &MK_CL_char_int);
...
struct mkcl_cfun mk_cl_char_name_cfunobj = MKCL_CFUN1(mk_cl_char_name, (mkcl_object) &MK_CL_char_name);
...
struct mkcl_cfun mk_cl_name_char_cfunobj = MKCL_CFUN1(mk_cl_name_char, (mkcl_object) &MK_CL_name_char);
