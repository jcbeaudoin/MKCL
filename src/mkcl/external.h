...
#define mk_si_schar_set mk_si_char_set
  ...
  extern MKCL_API mkcl_object mkcl_coerce_list_to_base_string(MKCL, mkcl_object l);
  extern MKCL_API mkcl_object mkcl_coerce_list_to_string(MKCL, mkcl_object l);
...
#define MKCL_GC_NO_INTR(env, expr) {			\
  ...
  extern MKCL_API mkcl_object mk_cl_prin1_to_string(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_princ_to_string(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  ...
  extern MKCL_API mkcl_object mk_cl_logical_pathname_translations(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  ...
  extern MKCL_API mkcl_object mk_cl_provide(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_require(MKCL, mkcl_narg narg, mkcl_object V1, ...);

  /* numlib.lsp */

  extern MKCL_API mkcl_object mk_cl_isqrt(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_phase(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_signum(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_cis(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_asin(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_acos(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_asinh(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_acosh(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_atanh(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  ...
  extern MKCL_API mkcl_object mk_cl_logtest(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  extern MKCL_API mkcl_object mk_cl_byte(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  extern MKCL_API mkcl_object mk_cl_byte_size(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_byte_position(MKCL, mkcl_narg narg, mkcl_object V1, ...);
  extern MKCL_API mkcl_object mk_cl_ldb(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  extern MKCL_API mkcl_object mk_cl_ldb_test(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  extern MKCL_API mkcl_object mk_cl_mask_field(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  extern MKCL_API mkcl_object mk_cl_dpb(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, mkcl_object V3, ...);
  extern MKCL_API mkcl_object mk_cl_deposit_field(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, mkcl_object V3, ...);

  /* packlib.lsp */

  extern MKCL_API mkcl_object mk_cl_find_all_symbols(MKCL, mkcl_narg, mkcl_object V1, ...);
  ...
  extern MKCL_API mkcl_object mk_si_find_relative_package(MKCL, mkcl_narg narg, mkcl_object pack_name, ...);
  extern MKCL_API mkcl_object mk_si_package_parent(MKCL, mkcl_narg narg, mkcl_object package_specifier, ...);
  ...
  extern MKCL_API mkcl_object mk_si_do_deftype(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, mkcl_object V3, ...);
  ...
  extern MKCL_API mkcl_object mk_cl_coerce(MKCL, mkcl_narg narg, mkcl_object V1, mkcl_object V2, ...);
  ...
  extern MKCL_API mkcl_object mk_cl_constantly(MKCL, mkcl_narg narg, mkcl_object V1, ...);
...
# define mkcl_bvset_index_raw mkcl_aset_index_bit_raw
  ...
  static inline mkcl_character mkcl_character_set_index_raw(MKCL, mkcl_object x, mkcl_index i, mkcl_character v)
  {
    ...
    if (x->d.t == mkcl_t_base_string) {
      ...
      if (mkcl_unlikely(v > 255)) mkcl_FEtype_error_base_char(env, MKCL_CODE_CHAR(v));
      (mkcl_likely(i < x->base_string.dim) ? self[i] = v : (i = mkcl_ensure_valid_array_index(env, x, i), self[i] = v));
      return v;
    } else {
      mkcl_character * self = x->string.self;
