...
/*
 * We always set MK_GC_GRANULE_BYTES to twice the length of a pointer.
 ...
 */
#ifndef MK_GC_GRANULE_BYTES
  /* MK_GC_GRANULE_BYTES should not be overridden in any instances of the GC */
...
# if defined(__LP64__) || defined (_LP64) || defined(_WIN64) \
	...
	|| defined(__arch64__)
#  define MK_GC_GRANULE_BYTES 16
#  define MK_GC_GRANULE_WORDS 2
# else
#  define MK_GC_GRANULE_BYTES 8
#  define MK_GC_GRANULE_WORDS 2
# endif
#endif /* !MK_GC_GRANULE_BYTES */

#if MK_GC_GRANULE_WORDS == 2
#  define MK_GC_WORDS_TO_GRANULES(n) ((n)>>1)
#else
#  define MK_GC_WORDS_TO_GRANULES(n) ((n)*sizeof(void *)/MK_GC_GRANULE_BYTES)
#endif
...
#ifndef MK_GC_TINY_FREELISTS
# if MK_GC_GRANULE_BYTES == 16
#   define MK_GC_TINY_FREELISTS 25
# else
#   define MK_GC_TINY_FREELISTS 33	/* Up to and including 256 bytes */
# endif
#endif /* !MK_GC_TINY_FREELISTS */

/* The ith free list corresponds to size i*MK_GC_GRANULE_BYTES	*/
...
#define MK_GC_RAW_BYTES_FROM_INDEX(i) ((i) * MK_GC_GRANULE_BYTES)

#endif /* MK_GC_TINY_FL_H */
