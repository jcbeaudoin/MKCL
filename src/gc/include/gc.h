 ...
 * For better performance, also look at MK_GC_MALLOC_ATOMIC, and
 * MK_GC_enable_incremental.  If you need an action to be performed
 * immediately before an object is collected, look at MK_GC_register_finalizer.
...
#include "gc_version.h"
        ...
        /* dynamic library.  MK_GC_get_version() can be used to obtain     */
        /* the latter.                                                  */
...
typedef void * MK_GC_PTR;  /* preserved only for backward compatibility    */
...
#ifdef _WIN64
# ifdef __int64
    typedef unsigned __int64 MK_GC_word;
    typedef __int64 MK_GC_signed_word;
# else
    typedef unsigned long long MK_GC_word;
    typedef long long MK_GC_signed_word;
# endif
#else
  typedef unsigned long MK_GC_word;
  typedef long MK_GC_signed_word;
#endif
...
MK_GC_API MK_GC_word MK_GC_CALL MK_GC_get_gc_no(void);
                        ...
                        /* it requires MK_GC_call_with_alloc_lock() to     */
...
MK_GC_API MK_GC_ATTR_DEPRECATED int MK_GC_java_finalization;
                        ...
                        /* work correctly.                              */
                        /* The setter and getter are unsynchronized.    */
MK_GC_API void MK_GC_CALL MK_GC_set_java_finalization(int);
...
MK_GC_API MK_GC_ATTR_DEPRECATED MK_GC_finalizer_notifier_proc MK_GC_finalizer_notifier;
                        ...
                        /* MK_GC_finalize_on_demand is set.                */
                        /* Typically this will notify a finalization    */
                        /* thread, which will call MK_GC_invoke_finalizers */
...
# endif
  int MK_GC_dont_gc;       /* != 0 ==> Don't collect.  In versions 6.2a1+, */
                        ...
                        /* normally be updated with MK_GC_enable() and     */
                        /* MK_GC_disable() calls.  Direct assignment to    */
                        /* MK_GC_dont_gc is deprecated.  To check whether  */
...
MK_GC_API MK_GC_ATTR_DEPRECATED int MK_GC_full_freq;
                        ...
                        /* MK_GC_call_with_alloc_lock() is required to     */
...
MK_GC_API MK_GC_ATTR_DEPRECATED MK_GC_word MK_GC_non_gc_bytes;
                        ...
                        /* MK_GC_malloc_uncollectable and MK_GC_free.         */
                        /* Wizards only.                                */
                        /* The setter and getter are unsynchronized, so */
                        /* MK_GC_call_with_alloc_lock() is required to     */
                        /* avoid data races (if the value is modified   */
...
MK_GC_API MK_GC_ATTR_DEPRECATED MK_GC_word MK_GC_free_space_divisor;
                        ...
                        /* Initially, MK_GC_free_space_divisor = 3.        */
...
MK_GC_API MK_GC_ATTR_DEPRECATED MK_GC_word MK_GC_max_retries;
                        ...
                        /* avoid data races (if the value is modified   */
                        /* after the GC is put to multi-threaded mode). */
MK_GC_API void MK_GC_CALL MK_GC_set_max_retries(MK_GC_word);
...
MK_GC_API MK_GC_ATTR_DEPRECATED char *MK_GC_stackbottom;
                                ...
                                /* should use MK_GC_get_stack_base(),      */
...
MK_GC_API MK_GC_ATTR_DEPRECATED unsigned long MK_GC_time_limit;
                               ...
                               /* MK_GC_TIME_UNLIMITED will essentially    */
                               /* disable incremental collection while  */
                               /* leaving generational collection       */
                               /* enabled.                              */
#define MK_GC_TIME_UNLIMITED 999999
                               /* Setting MK_GC_time_limit to this value   */
                        ...
                        /* avoid data races (if the value is modified   */
                        /* after the GC is put to multi-threaded mode). */
MK_GC_API void MK_GC_CALL MK_GC_set_time_limit(unsigned long);
...
/* MK_GC_set_pages_executable(1) call (before MK_GC_INIT) provided they are   */
/* going to execute code on any of the GC-allocated memory objects.     */
MK_GC_API void MK_GC_CALL MK_GC_set_pages_executable(int);

/* Returns non-zero value if the GC is set to the allocate-executable   */
/* mode.  The mode could be changed by MK_GC_set_pages_executable (before  */
/* MK_GC_INIT) unless the former has no effect on the platform.  Does not  */
...
/* MK_GC_free(0) is a no-op, as required by ANSI C for free.               */
MK_GC_API void MK_GC_CALL MK_GC_free(void *);
...
/* MK_GC_end_stubborn_change must be exactly the value returned by         */
/* MK_GC_malloc_stubborn or passed to MK_GC_change_stubborn.  (In the second  */
...
MK_GC_API void * MK_GC_CALL MK_GC_realloc(void * /* old_object */,
                                 size_t /* new_size_in_bytes */)
                        /* 'realloc' attr */ MK_GC_ATTR_ALLOC_SIZE(2);

/* Explicitly increase the heap size.   */
/* Returns 0 on failure, 1 on success.  */
MK_GC_API int MK_GC_CALL MK_GC_expand_hp(size_t /* number_of_bytes */);

/* Limit the heap size to n bytes.  Useful when you're debugging,       */
/* especially on systems that don't handle running out of memory well.  */
/* n == 0 ==> unbounded.  This is the default.  This setter function is */
/* unsynchronized (so it might require MK_GC_call_with_alloc_lock to avoid */
/* data races).                                                         */
...
MK_GC_API void MK_GC_CALL MK_GC_add_roots(void * /* low_address */,
                                 void * /* high_address_plus_1 */);

/* Remove a root segment.  Wizards only.                                */
/* May be unimplemented on some platforms.                              */
MK_GC_API void MK_GC_CALL MK_GC_remove_roots(void * /* low_address */,
                                    void * /* high_address_plus_1 */);

/* Add a displacement to the set of those considered valid by the       */
/* collector.  MK_GC_register_displacement(n) means that if p was returned */
/* by MK_GC_malloc, then (char *)p + n will be considered to be a valid    */
...
MK_GC_API void MK_GC_CALL MK_GC_register_displacement(size_t /* n */);

/* The following version should be used if any debugging allocation is  */
/* being done.                                                          */
MK_GC_API void MK_GC_CALL MK_GC_debug_register_displacement(size_t /* n */);
...
/* getter (see MK_GC_get_heap_size comment regarding thread-safety).       */
...
/* This is an unsynchronized getter (see MK_GC_get_heap_size comment       */
...
/* when MK_GC_get_heap_size and the friends were made lock-free again.)    */
MK_GC_API void MK_GC_CALL MK_GC_get_heap_usage_safe(MK_GC_word * /* pheap_size */,
                                           MK_GC_word * /* pfree_bytes */,
                                           MK_GC_word * /* punmapped_bytes */,
...
/* adverse effects.                                                     */
/* Safe to call before MK_GC_INIT().  Includes a  MK_GC_init() call.          */
MK_GC_API void MK_GC_CALL MK_GC_enable_incremental(void);

/* Does incremental mode write-protect pages?  Returns zero or  */
/* more of the following, or'ed together:                       */
#define MK_GC_PROTECTS_POINTER_HEAP  1 /* May protect non-atomic objs.     */
#define MK_GC_PROTECTS_PTRFREE_HEAP  2
#define MK_GC_PROTECTS_STATIC_DATA   4 /* Currently never.                 */
...
# define MK_GC_EXTRA_PARAMS MK_GC_word ra, const char * s, int i
#else
# define MK_GC_EXTRAS __FILE__, __LINE__
# define MK_GC_EXTRA_PARAMS const char * s, int i
#endif
...
# define MK_GC_REALLOC(old, sz) MK_GC_debug_realloc_replacement(old, sz)
#elif defined(MK_GC_DEBUG)
# define MK_GC_MALLOC(sz) MK_GC_debug_malloc(sz, MK_GC_EXTRAS)
# define MK_GC_REALLOC(old, sz) MK_GC_debug_realloc(old, sz, MK_GC_EXTRAS)
#else
# define MK_GC_MALLOC(sz) MK_GC_malloc(sz)
# define MK_GC_REALLOC(old, sz) MK_GC_realloc(old, sz)
#endif /* !MK_GC_DEBUG_REPLACEMENT && !MK_GC_DEBUG */

#ifdef MK_GC_DEBUG
# define MK_GC_MALLOC_ATOMIC(sz) MK_GC_debug_malloc_atomic(sz, MK_GC_EXTRAS)
# define MK_GC_STRDUP(s) MK_GC_debug_strdup(s, MK_GC_EXTRAS)
# define MK_GC_STRNDUP(s, sz) MK_GC_debug_strndup(s, sz, MK_GC_EXTRAS)
# define MK_GC_MALLOC_ATOMIC_UNCOLLECTABLE(sz) \
                        MK_GC_debug_malloc_atomic_uncollectable(sz, MK_GC_EXTRAS)
# define MK_GC_MALLOC_UNCOLLECTABLE(sz) \
                        MK_GC_debug_malloc_uncollectable(sz, MK_GC_EXTRAS)
# define MK_GC_MALLOC_IGNORE_OFF_PAGE(sz) \
                        MK_GC_debug_malloc_ignore_off_page(sz, MK_GC_EXTRAS)
# define MK_GC_MALLOC_ATOMIC_IGNORE_OFF_PAGE(sz) \
                        MK_GC_debug_malloc_atomic_ignore_off_page(sz, MK_GC_EXTRAS)
# define MK_GC_FREE(p) MK_GC_debug_free(p)
# define MK_GC_REGISTER_FINALIZER(p, f, d, of, od) \
      MK_GC_debug_register_finalizer(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_IGNORE_SELF(p, f, d, of, od) \
      MK_GC_debug_register_finalizer_ignore_self(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_NO_ORDER(p, f, d, of, od) \
      MK_GC_debug_register_finalizer_no_order(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_UNREACHABLE(p, f, d, of, od) \
      MK_GC_debug_register_finalizer_unreachable(p, f, d, of, od)
# define MK_GC_MALLOC_STUBBORN(sz) MK_GC_debug_malloc_stubborn(sz, MK_GC_EXTRAS)
...
# define MK_GC_STRDUP(s) MK_GC_strdup(s)
# define MK_GC_STRNDUP(s, sz) MK_GC_strndup(s, sz)
# define MK_GC_MALLOC_ATOMIC_UNCOLLECTABLE(sz) MK_GC_malloc_atomic_uncollectable(sz)
# define MK_GC_MALLOC_UNCOLLECTABLE(sz) MK_GC_malloc_uncollectable(sz)
# define MK_GC_MALLOC_IGNORE_OFF_PAGE(sz) \
                        MK_GC_malloc_ignore_off_page(sz)
# define MK_GC_MALLOC_ATOMIC_IGNORE_OFF_PAGE(sz) \
                        MK_GC_malloc_atomic_ignore_off_page(sz)
# define MK_GC_FREE(p) MK_GC_free(p)
# define MK_GC_REGISTER_FINALIZER(p, f, d, of, od) \
      MK_GC_register_finalizer(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_IGNORE_SELF(p, f, d, of, od) \
      MK_GC_register_finalizer_ignore_self(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_NO_ORDER(p, f, d, of, od) \
      MK_GC_register_finalizer_no_order(p, f, d, of, od)
# define MK_GC_REGISTER_FINALIZER_UNREACHABLE(p, f, d, of, od) \
      MK_GC_register_finalizer_unreachable(p, f, d, of, od)
# define MK_GC_MALLOC_STUBBORN(sz) MK_GC_malloc_stubborn(sz)
# define MK_GC_CHANGE_STUBBORN(p) MK_GC_change_stubborn(p)
...
#define MK_GC_NEW(t)               ((t*)MK_GC_MALLOC(sizeof(t)))
#define MK_GC_NEW_ATOMIC(t)        ((t*)MK_GC_MALLOC_ATOMIC(sizeof(t)))
#define MK_GC_NEW_STUBBORN(t)      ((t*)MK_GC_MALLOC_STUBBORN(sizeof(t)))
#define MK_GC_NEW_UNCOLLECTABLE(t) ((t*)MK_GC_MALLOC_UNCOLLECTABLE(sizeof(t)))
...
# else
#   define MK_GC_WCSDUP(s) MK_GC_wcsdup(s)
# endif
...
typedef void (MK_GC_CALLBACK * MK_GC_finalization_proc)(void * /* obj */,
                                                  void * /* client_data */);
...
MK_GC_API void MK_GC_CALL MK_GC_debug_register_finalizer(void * /* obj */,
        ...
        /* routines.                                            */
        /* If MK_GC_register_finalizer is aborted as a result of   */
...
/* finalizers.                                                  */
/* Only works if MK_GC_java_finalization is set.  Probably only    */
...
/* use involves calling MK_GC_register_disappearing_link(&p),      */
...
MK_GC_API int MK_GC_CALL MK_GC_register_disappearing_link(void ** /* link */)
        ...
        /* examines connectivity.  Returns MK_GC_DUPLICATE if link */
        /* was already registered, MK_GC_SUCCESS if registration   */
        /* succeeded, MK_GC_NO_MEMORY if it failed for lack of     */
...
MK_GC_API int MK_GC_CALL MK_GC_general_register_disappearing_link(void ** /* link */,
        ...
        /* allocated by MK_GC_malloc or friends.  It is unsafe to  */
        ...
        /* MK_GC_call_with_alloc_lock() below) when the disguised  */
        ...
        /* cleared.  Returns MK_GC_SUCCESS if registration         */
        /* succeeded (a new link is registered), MK_GC_DUPLICATE   */
...
MK_GC_API int MK_GC_CALL MK_GC_invoke_finalizers(void);
        /* Run finalizers for all objects that are ready to     */
        /* be finalized.  Return the number of finalizers       */
        /* that were run.  Normally this is also called         */
        /* implicitly during some allocations.  If              */
        /* MK_GC_finalize_on_demand is nonzero, it must be called  */
        /* explicitly.                                          */
...
# define MK_GC_reachable_here(ptr) \
                __asm__ __volatile__(" " : : "X"(ptr) : "memory")
#else
  MK_GC_API void MK_GC_CALL MK_GC_noop1(MK_GC_word);
# define MK_GC_reachable_here(ptr) MK_GC_noop1((MK_GC_word)(ptr))
#endif
...
typedef MK_GC_word MK_GC_hidden_pointer;
#define MK_GC_HIDE_POINTER(p) (~(MK_GC_hidden_pointer)(p))
/* Converting a hidden pointer to a real pointer requires verifying     */
/* that the object still exists.  This involves acquiring the           */
/* allocator lock to avoid a race with the collector.                   */
#define MK_GC_REVEAL_POINTER(p) ((void *)MK_GC_HIDE_POINTER(p))

#if defined(I_HIDE_POINTERS) || defined(MK_GC_I_HIDE_POINTERS)
  /* This exists only for compatibility (the GC-prefixed symbols are    */
  /* preferred for new code).                                           */
# define HIDE_POINTER(p) MK_GC_HIDE_POINTER(p)
# define REVEAL_POINTER(p) MK_GC_REVEAL_POINTER(p)
#endif
...
typedef void * (MK_GC_CALLBACK * MK_GC_stack_base_func)(
                struct MK_GC_stack_base * /* sb */, void * /* arg */);

/* Call a function with a stack base structure corresponding to         */
/* somewhere in the MK_GC_call_with_stack_base frame.  This often can      */
...
#define MK_GC_NOT_FOUND 4          /* Requested link not found (returned   */
  ...
  /* MK_GC_INIT() and other GC routines.  Should be avoided if             */
  /* MK_GC_pthread_create, MK_GC_beginthreadex (or MK_GC_CreateThread) could be  */
  ...
  /* always done implicitly.  This is normally done implicitly if MK_GC_   */
  ...
  /* MK_GC_use_threads_discovery() is called at start-up.  Except for the  */
...
/* heap).  MK_GC_call_with_gc_active() has the functionality opposite to   */
/* MK_GC_do_blocking() one.  It is assumed that the collector is already   */
...
MK_GC_API void * MK_GC_CALL MK_GC_same_obj(void * /* p */, void * /* q */);
...
MK_GC_API void * MK_GC_CALL MK_GC_is_visible(void * /* p */);

/* Check that if p is a pointer to a heap page, then it points to       */
/* a valid displacement within a heap object.                           */
/* Fail conspicuously if this property does not hold.                   */
/* Uninteresting with MK_GC_all_interior_pointers.                         */
/* Always returns its argument.                                         */
MK_GC_API void * MK_GC_CALL MK_GC_is_valid_displacement(void * /* p */);

/* Explicitly dump the GC state.  This is most often called from the    */
/* debugger, or by setting the MK_GC_DUMP_REGULARLY environment variable,  */
...
/* Note that MK_GC_PTR_ADD evaluates the first argument more than once.    */
#if defined(MK_GC_DEBUG) && defined(__GNUC__)
# define MK_GC_PTR_ADD3(x, n, type_of_result) \
        ((type_of_result)MK_GC_same_obj((x)+(n), (x)))
# define MK_GC_PRE_INCR3(x, n, type_of_result) \
        ((type_of_result)MK_GC_pre_incr((void **)(&(x)), (n)*sizeof(*x)))
# define MK_GC_POST_INCR3(x, n, type_of_result) \
        ((type_of_result)MK_GC_post_incr((void **)(&(x)), (n)*sizeof(*x)))
# define MK_GC_PTR_ADD(x, n) MK_GC_PTR_ADD3(x, n, typeof(x))
# define MK_GC_PRE_INCR(x, n) MK_GC_PRE_INCR3(x, n, typeof(x))
# define MK_GC_POST_INCR(x) MK_GC_POST_INCR3(x, 1, typeof(x))
# define MK_GC_POST_DECR(x) MK_GC_POST_INCR3(x, -1, typeof(x))
#else /* !MK_GC_DEBUG || !__GNUC__ */
...
# define MK_GC_PTR_ADD(x, n) ((x)+(n))
# define MK_GC_PRE_INCR(x, n) ((x) += (n))
# define MK_GC_POST_INCR(x) ((x)++)
# define MK_GC_POST_DECR(x) ((x)--)
#endif /* !MK_GC_DEBUG || !__GNUC__ */

/* Safer assignment of a pointer to a non-stack location.       */
#ifdef MK_GC_DEBUG
# define MK_GC_PTR_STORE(p, q) \
        (*(void **)MK_GC_is_visible(p) = MK_GC_is_valid_displacement(q))
#else
# define MK_GC_PTR_STORE(p, q) (*(p) = (q))
#endif

/* Functions called to report pointer checking errors */
MK_GC_API void (MK_GC_CALLBACK * MK_GC_same_obj_print_proc)(void * /* p */,
                                                   void * /* q */);
MK_GC_API void (MK_GC_CALLBACK * MK_GC_is_valid_displacement_print_proc)(void *);
MK_GC_API void (MK_GC_CALLBACK * MK_GC_is_visible_print_proc)(void *);
...
typedef int (MK_GC_CALLBACK * MK_GC_has_static_roots_func)(
...
#     define MK_GC_CreateThread _MK_GC_CreateThread
...
#   define MK_GC_WIN32_SIZE_T MK_GC_uintptr_t
    ...
    /* compatibility, it is possible to build the GC with MK_GC_DLL        */
    /* defined, and to call MK_GC_use_threads_discovery.  This implicitly  */
    ...
    /* terminate normally, or call MK_GC_endthreadex() or MK_GC_ExitThread,   */
...
#   endif
    ...
    MK_GC_API DECLSPEC_NORETURN void WINAPI MK_GC_ExitThread(
                                                DWORD /* dwExitCode */);
...
# endif /* !MK_GC_NO_THREAD_DECLS */

# ifdef MK_GC_WINMAIN_REDIRECT
    /* win32_threads.c implements the real WinMain(), which will start  */
    /* a new thread to call MK_GC_WinMain() after initializing the garbage */
    /* collector.                                                       */
#   define WinMain MK_GC_WinMain
# endif

  /* For compatibility only. */
# define MK_GC_use_DllMain MK_GC_use_threads_discovery
...
/* value is controlled by MK_GC_FORCE_UNMAP_ON_GCOLLECT.  The setter and   */
/* getter are unsynchronized.                                           */
MK_GC_API void MK_GC_CALL MK_GC_set_force_unmap_on_gcollect(int);
MK_GC_API int MK_GC_CALL MK_GC_get_force_unmap_on_gcollect(void);

/* Fully portable code should call MK_GC_INIT() from the main program      */
/* before making any other MK_GC_ calls.  On most platforms this is a      */
/* no-op and the collector self-initializes.  But a number of           */
/* platforms make that too hard.                                        */
/* A MK_GC_INIT call is required if the collector is built with            */
/* THREAD_LOCAL_ALLOC defined and the initial allocation call is not    */
/* to MK_GC_malloc() or MK_GC_malloc_atomic().                                */
...
# define MK_GC_INIT_CONF_ROOTS /* empty */
  ...
  /* Set MK_GC_dont_expand to TRUE at start-up */
# define MK_GC_INIT_CONF_DONT_EXPAND MK_GC_set_dont_expand(1)
#else
# define MK_GC_INIT_CONF_DONT_EXPAND /* empty */
#endif

#ifdef MK_GC_FORCE_UNMAP_ON_GCOLLECT
  /* Turn on "unmap as much as possible on explicit GC" mode at start-up */
# define MK_GC_INIT_CONF_FORCE_UNMAP_ON_GCOLLECT \
                MK_GC_set_force_unmap_on_gcollect(1)
#else
...
#else
# define MK_GC_INIT_CONF_MAX_RETRIES /* empty */
#endif

#ifdef MK_GC_FREE_SPACE_DIVISOR
  /* Set MK_GC_free_space_divisor to the desired value at start-up */
# define MK_GC_INIT_CONF_FREE_SPACE_DIVISOR \
                MK_GC_set_free_space_divisor(MK_GC_FREE_SPACE_DIVISOR)
#else
# define MK_GC_INIT_CONF_FREE_SPACE_DIVISOR /* empty */
#endif

#ifdef MK_GC_FULL_FREQ
  /* Set MK_GC_full_freq to the desired value at start-up */
# define MK_GC_INIT_CONF_FULL_FREQ MK_GC_set_full_freq(MK_GC_FULL_FREQ)
#else
# define MK_GC_INIT_CONF_FULL_FREQ /* empty */
#endif

#ifdef MK_GC_TIME_LIMIT
  /* Set MK_GC_time_limit to the desired value at start-up */
...
# define MK_GC_INIT_CONF_MAXIMUM_HEAP_SIZE \
                MK_GC_set_max_heap_size(MK_GC_MAXIMUM_HEAP_SIZE)
#else
# define MK_GC_INIT_CONF_MAXIMUM_HEAP_SIZE /* empty */
#endif

#ifdef MK_GC_IGNORE_WARN
  /* Turn off all warnings at start-up (after GC initialization) */
# define MK_GC_INIT_CONF_IGNORE_WARN MK_GC_set_warn_proc(MK_GC_ignore_warn_proc)
#else
# define MK_GC_INIT_CONF_IGNORE_WARN /* empty */
#endif

#ifdef MK_GC_INITIAL_HEAP_SIZE
  /* Set heap size to the desired value at start-up */
# define MK_GC_INIT_CONF_INITIAL_HEAP_SIZE \
                { size_t heap_size = MK_GC_get_heap_size(); \
                  if (heap_size < (MK_GC_INITIAL_HEAP_SIZE)) \
                    (void)MK_GC_expand_hp((MK_GC_INITIAL_HEAP_SIZE) - heap_size); }
#else
# define MK_GC_INIT_CONF_INITIAL_HEAP_SIZE /* empty */
#endif
...
/* primordial thread.                                                   */
#define MK_GC_INIT() { MK_GC_INIT_CONF_DONT_EXPAND; /* pre-init */ \
                    MK_GC_INIT_CONF_FORCE_UNMAP_ON_GCOLLECT; \
                    MK_GC_INIT_CONF_MAX_RETRIES; \
                    ...
                    MK_GC_INIT_CONF_IGNORE_WARN; \
                    MK_GC_INIT_CONF_INITIAL_HEAP_SIZE; }
