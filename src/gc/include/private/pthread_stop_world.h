...
#ifndef MK_GC_PTHREAD_STOP_WORLD_H
#define MK_GC_PTHREAD_STOP_WORLD_H

struct thread_stop_info {
#   ifndef MK_GC_OPENBSD_THREADS
      word last_stop_count;     /* MK_GC_last_stop_count value when thread */
...
#   ifdef NACL
      /* Grab NACL_MK_GC_REG_STORAGE_SIZE pointers off the stack when      */
...
#     define NACL_MK_GC_REG_STORAGE_SIZE 20
      ptr_t reg_storage[NACL_MK_GC_REG_STORAGE_SIZE];
#   endif
};
