...
double __mkcc_floatundidf(unsigned long long a)
{
    DWunion uu; 
    XFtype r;
...
long double __mkcc_floatundixf(unsigned long long a)
{
    DWunion uu; 
    XFtype r;
...
unsigned long long __mkcc_fixunssfdi (float a1)
{
...
unsigned long long __mkcc_fixunsdfdi (double a1)
{
...
unsigned long long __mkcc_fixunsxfdi (long double a1)
{
...
long long __mkcc_fixsfdi (float a1)
{
    long long ret; int s;
    ret = __mkcc_fixunssfdi((s = a1 >= 0) ? a1 : -a1);
    return s ? ret : -ret;
}

long long __mkcc_fixdfdi (double a1)
{
    long long ret; int s;
    ret = __mkcc_fixunsdfdi((s = a1 >= 0) ? a1 : -a1);
    return s ? ret : -ret;
}

long long __mkcc_fixxfdi (long double a1)
{
    long long ret; int s;
    ret = __mkcc_fixunsxfdi((s = a1 >= 0) ? a1 : -a1);
    return s ? ret : -ret;
}
...
/* Flushing for mkccrun */
#if defined(MKCC_TARGET_X86_64) || defined(MKCC_TARGET_I386)
