...
#ifdef CONFIG_MKCCASSERT
#include <assert.h>
#define MKCC_ASSERT(ex) assert(ex)
#else
#define MKCC_ASSERT(ex)
#endif
...
#  define LIBMKCCAPI __declspec(dllexport)
#  define PUB_FUNC LIBMKCCAPI
# endif
# ifdef _MSC_VER
...
# define MKCC_OUTPUT_DLL_WITH_PLT
#else
...
/* target selection */
/* #define MKCC_TARGET_I386   *//* i386 code generator */
/* #define MKCC_TARGET_ARM    *//* ARMv4 code generator */
/* #define MKCC_TARGET_ARM64  *//* ARMv8 code generator */
/* #define MKCC_TARGET_C67    *//* TMS320C67xx code generator */
/* #define MKCC_TARGET_X86_64 *//* x86-64 code generator */

/* default target is I386 */
#if !defined(MKCC_TARGET_I386) && !defined(MKCC_TARGET_ARM) && \
    !defined(MKCC_TARGET_ARM64) && !defined(MKCC_TARGET_C67) && \
    !defined(MKCC_TARGET_X86_64)
#define MKCC_TARGET_I386
#endif

#if CONFIG_MKCC_ADD_BCHECK
#if !defined(MKCC_UCLIBC) && !defined(MKCC_TARGET_ARM) && \
    !defined(MKCC_TARGET_ARM64) && !defined(MKCC_TARGET_C67) && \
    !defined(CONFIG_USE_LIBGCC)
#define CONFIG_MKCC_BCHECK /* enable bound checking code */
#endif
#endif

/* define it to include assembler support */
#if !defined(MKCC_TARGET_ARM) && !defined(MKCC_TARGET_ARM64) && \
    !defined(MKCC_TARGET_C67)
#define CONFIG_MKCC_ASM
#endif

/* object format selection */
#if defined(MKCC_TARGET_C67)
#define MKCC_TARGET_COFF
#endif

/* only native compiler supports -run */
#if defined _WIN32 == defined MKCC_TARGET_PE
# if (defined __i386__ || defined _X86_) && defined MKCC_TARGET_I386
#  define MKCC_IS_NATIVE
# elif (defined __x86_64__ || defined _AMD64_) && defined MKCC_TARGET_X86_64
#  define MKCC_IS_NATIVE
# elif defined __arm__ && defined MKCC_TARGET_ARM
#  define MKCC_IS_NATIVE
# elif defined __aarch64__ && defined MKCC_TARGET_ARM64
#  define MKCC_IS_NATIVE
# endif
#endif

#if defined MKCC_IS_NATIVE && !defined CONFIG_MKCCBOOT
# define CONFIG_MKCC_BACKTRACE
#endif
...
#endif
#ifndef CONFIG_MKCCDIR
# define CONFIG_MKCCDIR "."
#endif
#ifndef CONFIG_LDDIR
...
#ifndef CONFIG_MKCC_CRTPREFIX
# define CONFIG_MKCC_CRTPREFIX USE_MUADIR(CONFIG_SYSROOT "/usr/" CONFIG_LDDIR)
#endif

/* Below: {B} is substituted by CONFIG_MKCCDIR (rsp. -B option) */

/* system include paths */
#ifndef CONFIG_MKCC_SYSINCLUDEPATHS
# ifdef MKCC_TARGET_PE
#  define CONFIG_MKCC_SYSINCLUDEPATHS "{B}/include;{B}/include/winapi"
# else
#  define CONFIG_MKCC_SYSINCLUDEPATHS \
        "{B}/include" \
...
#ifndef CONFIG_MKCC_LIBPATHS
# ifdef MKCC_TARGET_PE
#  define CONFIG_MKCC_LIBPATHS "{B}/lib"
# else
#  define CONFIG_MKCC_LIBPATHS \
...
#ifndef CONFIG_MKCC_ELFINTERP
# if defined __FreeBSD__
#  define CONFIG_MKCC_ELFINTERP "/libexec/ld-elf.so.1"
# elif defined __FreeBSD_kernel__
#  if defined(MKCC_TARGET_X86_64)
#   define CONFIG_MKCC_ELFINTERP "/lib/ld-kfreebsd-x86-64.so.1"
#  else
#   define CONFIG_MKCC_ELFINTERP "/lib/ld.so.1"
#  endif
# elif defined __DragonFly__
#  define CONFIG_MKCC_ELFINTERP "/usr/libexec/ld-elf.so.2"
# elif defined __NetBSD__
#  define CONFIG_MKCC_ELFINTERP "/usr/libexec/ld.elf_so"
# elif defined __GNU__
#  define CONFIG_MKCC_ELFINTERP "/lib/ld.so"
# elif defined(MKCC_TARGET_PE)
#  define CONFIG_MKCC_ELFINTERP "-"
# elif defined(MKCC_UCLIBC)
#  define CONFIG_MKCC_ELFINTERP "/lib/ld-uClibc.so.0" /* is there a uClibc for x86_64 ? */
# elif defined MKCC_TARGET_ARM64
#  define CONFIG_MKCC_ELFINTERP "/lib/ld-linux-aarch64.so.1"
# elif defined(MKCC_TARGET_X86_64)
#  define CONFIG_MKCC_ELFINTERP "/lib64/ld-linux-x86-64.so.2"
# elif !defined(MKCC_ARM_EABI)
#  define CONFIG_MKCC_ELFINTERP "/lib/ld-linux.so.2"
# endif
#endif

/* var elf_interp dans *-gen.c */
#ifdef CONFIG_MKCC_ELFINTERP
# define DEFAULT_ELFINTERP(s) CONFIG_MKCC_ELFINTERP
#else
# define DEFAULT_ELFINTERP(s) default_elfinterp(s)
#endif

/* library to use with CONFIG_USE_LIBGCC instead of libmkcc1.a */
#define MKCC_LIBGCC USE_MUADIR(CONFIG_SYSROOT "/" CONFIG_LDDIR) "/libgcc_s.so.1"
...
typedef struct BufferedFile {
    ...
    int line_ref;    /* mkcc -E: last printed line */
...
struct MKCCState {
    ...
    char *mkcc_lib_path; /* CONFIG_MKCCDIR or -B option */
    char *soname; /* as specified on the command line (-soname) */
    char *rpath; /* as specified on the command line (-Wl,-rpath=) */

    /* output type, see MKCC_OUTPUT_XXX */
    int output_type;
    /* output format, see MKCC_OUTPUT_FORMAT_xxx */
    int output_format;
...
# endif
    ...
    /* used by main and mkcc_parse_args only */
...
/* public functions currently used by the mkcc main function */
...
#else
#define mkcc_free(ptr)           mkcc_free_debug(ptr)
#define mkcc_malloc(size)        mkcc_malloc_debug(size, __FILE__, __LINE__)
#define mkcc_mallocz(size)       mkcc_mallocz_debug(size, __FILE__, __LINE__)
#define mkcc_realloc(ptr,size)   mkcc_realloc_debug(ptr, size, __FILE__, __LINE__)
#define mkcc_strdup(str)         mkcc_strdup_debug(str, __FILE__, __LINE__)
...
#else
#define greloc(s, sym, off, type) greloca(s, sym, off, type, 0)
#endif
...
PUB_FUNC int mkcc_add_library_err(MKCCState *s, const char *f);
...
ST_FUNC void preprocess_init(MKCCState *s1);
ST_FUNC void preprocess_new(void);
ST_FUNC void preprocess_delete(void);
ST_FUNC int mkcc_preprocess(MKCCState *s1);
...
#if defined CONFIG_MKCC_BCHECK || defined MKCC_TARGET_C67
ST_FUNC Sym *get_sym_ref(CType *type, Section *sec, unsigned long offset, unsigned long size);
#endif
#if defined MKCC_TARGET_X86_64 && !defined MKCC_TARGET_PE
ST_FUNC int classify_x86_64_va_arg(CType *ty);
#endif

/* ------------ mkccelf.c ------------ */

#define MKCC_OUTPUT_FORMAT_ELF    0 /* default output format: ELF */
#define MKCC_OUTPUT_FORMAT_BINARY 1 /* binary image output */
#define MKCC_OUTPUT_FORMAT_COFF   2 /* COFF */
...
ST_FUNC Section *new_symtab(MKCCState *s1, const char *symtab_name, int sh_type, int sh_flags, const char *strtab_name, const char *hash_name, int hash_sh_flags);
...
ST_FUNC int mkcc_load_object_file(MKCCState *s1, int fd, unsigned long file_offset);
...
#ifndef MKCC_TARGET_C67
ST_FUNC void o(unsigned int c);
#endif
#ifndef MKCC_TARGET_ARM
...
/* ------------ arm-gen.c ------------ */
#ifdef MKCC_TARGET_ARM
#if defined(MKCC_ARM_EABI) && !defined(CONFIG_MKCC_ELFINTERP)
ST_FUNC char *default_elfinterp(struct MKCCState *s);
#endif
ST_FUNC void arm_init(struct MKCCState *s);
...
ST_FUNC int mkcc_output_coff(MKCCState *s1, FILE *f);
ST_FUNC int mkcc_load_coff(MKCCState * s1, int fd);
#endif
...
ST_FUNC void asm_expr(MKCCState *s1, ExprValue *pe);
ST_FUNC int asm_int_expr(MKCCState *s1);
ST_FUNC int mkcc_assemble(MKCCState *s1, int do_preprocess);
/* ------------ i386-asm.c ------------ */
ST_FUNC void gen_expr32(ExprValue *pe);
ST_FUNC void asm_opcode(MKCCState *s1, int opcode);
...
/* ------------ mkccpe.c -------------- */
#ifdef MKCC_TARGET_PE
ST_FUNC int pe_load_file(struct MKCCState *s1, const char *filename, int fd);
ST_FUNC int pe_output_file(MKCCState * s1, const char *filename);
ST_FUNC int pe_putimport(MKCCState *s1, int dllindex, const char *name, addr_t value);
...
ST_FUNC void *resolve_sym(MKCCState *s1, const char *symbol);
#elif !defined _WIN32
ST_FUNC void *resolve_sym(MKCCState *s1, const char *symbol);
#endif
...
ST_FUNC void mkcc_set_num_callers(int n);
#endif
#endif
