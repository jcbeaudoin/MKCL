/*
 *  x86-64 code generator for MKCC
 *
...
#define EM_MKCC_TARGET EM_X86_64
...
#else
    mkcc_error("internal error: no GOT on PE: %s %x %x | %02x %02x %02x\n",
...
ST_FUNC void gen_bounded_ptr_deref(void)
{
    ...
    size = 0;
    /* XXX: put that code in generic part of mkcc */
    ...
    default:
        mkcc_error("unhandled size when dereferencing bounded pointer");
        func = 0;
        break;
    }
...
#else
                if (seen_reg_num + reg_count <= REGN) { /* JCB */
#endif
