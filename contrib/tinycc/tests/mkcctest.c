...
// MinGW has 80-bit rather than 64-bit long double which isn't compatible with MKCC or MSVC
...
#define MKCCLIB_INC <mkcclib.h>
#define MKCCLIB_INC1 <mkcclib
#define MKCCLIB_INC2 h>
#define MKCCLIB_INC3 "mkcclib"

#include MKCCLIB_INC

#include MKCCLIB_INC1.MKCCLIB_INC2

#include MKCCLIB_INC1.h>

/* gcc 3.2 does not accept that (bug ?) */
//#include MKCCLIB_INC3 ".h"
...
/* space is needed because mkcc preprocessor introduces a space between each token */
