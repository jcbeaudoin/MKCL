...
(defun weak-pointer-p (object)
  ...
  #+mkcl (progn (identity object) (error "not implemented"))
...
(defun weak-pointer-value (weak-pointer)
  ...
  #+mkcl (progn (identity weak-pointer) (error "not implemented"))
  ...
  #+ecl (let ((next-fn (ext:get-finalizer object)))
          (ext:set-finalizer
           object (lambda (obj)
                    ...
                    (when next-fn
                      (funcall next-fn nil)))))
  #+mkcl (let ((next-fn (si:get-finalizer object)))
           (si:set-finalizer
            object (lambda (obj)
                     (declare (ignore obj))
                     (funcall function)
...
(defun cancel-finalization (object)
  ...
  #+mkcl (si:set-finalizer object nil)
  #+allegro
  (progn
