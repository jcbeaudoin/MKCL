...
(definterface doze-in-repl ()
  "This function provides a sleeping point and thus assures that
OS level streams are free of locks and can be safely be written to
without fear of hanging. It is meant to be called by the from within
the REPL of the initial/*inferior-lisp* thread in spawn mode."
  (loop (sleep 1)))
